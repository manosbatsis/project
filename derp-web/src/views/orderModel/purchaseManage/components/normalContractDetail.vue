  ...
  <div class="step-bx">
    <JFX-Form :model="ruleForm" ref="ruleForm">
      ...
      >
        ...
        <el-table-column prop="num" label="数量" align="center" width="120">
          <template slot="header">
            <div>
              数量
              <br />
        ...
        <el-table-column label="销售单价" align="center" width="160">
          <template slot="header">
            <div>
              单价({{ detail.currency }})
              <br />
      ...
      <el-row :gutter="10" class="fs-14 clr-II ot-lisy">
        ...
        <el-col class="ot-lisy-oy" :span="24">
          <el-form-item label="付款方式：" prop="paymentMethod">
            <el-radio v-model="ruleForm.paymentMethod" label="1" disabled>
              一次结清
            </el-radio>
            <el-radio v-model="ruleForm.paymentMethod" label="2" disabled>
              分批付款
            </el-radio>
            <el-radio v-model="ruleForm.paymentMethod" label="3" disabled>
              其他
            </el-radio>
          </el-form-item>
        </el-col>
