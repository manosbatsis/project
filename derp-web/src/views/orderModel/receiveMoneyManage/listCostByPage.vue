  ...
  <div>
    ...
    <el-row class="mr-t-20">
      <el-col :span="24">
        <el-button
          type="primary"
          v-permission="'listCostByPage_flash'"
          @click="refresh"
        >
          刷新
        </el-button>
        <el-button
          type="primary"
          v-permission="'listCostByPage_export'"
          @click="exportExcel"
        >
          月结导出
        </el-button>
  ...
  export default {
    ...
    methods: {
      ...
      async exportExcel() {
        ...
        await exportCostMonthly(exportJson)
