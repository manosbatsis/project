  ...
  <div>
    ...
    <el-row class="mr-t-20">
      <el-col :span="24">
        <el-button
          type="primary"
          v-permission="'toBTempRevenueMonthlySnapshot_flash'"
          @click="refresh"
        >
          刷新
        </el-button>
        <el-button
          type="primary"
          v-permission="'toBTempRevenueMonthlySnapshot_export'"
          @click="exportExcel"
        >
          月结导出
        </el-button>
...
<script>
  ...
  import {
    listToBTempMonthlySnapshot,
    flashTobTempMonthlySnapshot,
    exportToBTempRevenueMonthlySnapshotUrl
      ...
      return {
        ...
        tableColumn: [
          ...
          },
          {
            ...
            hide: true,
            formatter(row) {
              return (row.currency || '') + ' ' + (row.price || 0)
            }
          },
          {
            label: '核销应收金额',
    ...
    methods: {
      ...
      async getList(pageNum) {
        try {
          ...
          const {
            data: { list, total }
          } = await listToBTempMonthlySnapshot({
      ...
      async refresh() {
        ...
        await flashTobTempMonthlySnapshot({
      ...
      exportExcel() {
        ...
        this.$exportFile(exportToBTempRevenueMonthlySnapshotUrl, exportJson)
      }
    }
  }
</script>
