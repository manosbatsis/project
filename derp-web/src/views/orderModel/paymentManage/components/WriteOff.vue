  ...
  <div>
    ...
    >
      <el-row :gutter="10" class="fs-14 clr-II detail-row">
        <el-col :span="12">应付账单号：{{ detail.code || '- -' }}</el-col>
        <el-col :span="12">
          应付金额：{{
            `${detail.currency || ''} ${detail.surplusAmount || '0'}`
          }}
        </el-col>
        ...
        <el-col :span="24">
          ...
          >
            ...
            <template slot="currentVerificateAmount" slot-scope="{ row }">
              <JFX-Input
                v-if="row.edit"
                v-model.trim="row.currentVerificateAmount"
                :precision="2"
                :min="0"
                style="width: 100%"
              />
    ...
    data() {
      return {
        ...
        tableColumn: [
          ...
          {
            label: '本次付款金额',
            slotTo: 'currentVerificateAmount',
            minWidth: '150',
            align: 'center',
            hide: true
          },
    ...
    methods: {
      ...
      async comfirm() {
        ...
        try {
          ...
          if (
            currentVerificateAmount === null ||
            currentVerificateAmount === undefined ||
            currentVerificateAmount === ''
          ) {
