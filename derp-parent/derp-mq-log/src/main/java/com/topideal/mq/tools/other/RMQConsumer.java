...
public class RMQConsumer {
    ...
    //消费者组名
    @Value("${derplogrocketmq.derplog.consumergroup}")
    private String consumerGroup;
    //消息主题
    @Value("${derplogrocketmq.derplog.topics}")
    ...
    public void init() {
        ...
        logger.info("初始化消费者完成-其他...group="+consumer.getConsumerGroup()+" instance="+consumer.getInstanceName());
    }
