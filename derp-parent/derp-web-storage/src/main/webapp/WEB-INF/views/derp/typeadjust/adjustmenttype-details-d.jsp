                        ...
                        <div class="row col-12 mt10">
                            <table id="datatable-buttons" class="table table-striped" cellspacing="0"
                                ...
                                <tr>
                                    ...
                                    <th style="white-space:nowrap;">好坏品</th>
                                    <th style="white-space:nowrap;">调整类型</th>
                                    <th style="white-space:nowrap;">调整归属</th>
                                </tr>
                                </thead>
                                <tbody>
                                <c:forEach items="${detail.itemList }" var="item" varStatus="status">
	                                <tr>
                                        ...
                                        <td>${item.isDamageLabel}
	                                      <%--<c:choose>--%>
                                 		    <%--<c:when test="${item.isDamage eq '0' }">好品</c:when>--%>
                                 		    <%--<c:when test="${item.isDamage eq '1' }">坏品</c:when>                               		 --%>
                                 	      <%--</c:choose>                                    --%>
	                                    </td>
                                        <td>${item.typeLabel}
	                                      <%--<c:choose>--%>
	                                    ...
	                                    <td>${item.typeSourceLabel}
	                                      <%--<c:choose>
                                 		    <c:when test="${item.type eq '0' }">调整前</c:when>
                                 		    <c:when test="${item.type eq '1' }">调整后</c:when>
                                 	      </c:choose>--%>
	                                    </td>
	                                </tr>
                                </c:forEach>
