            ...
            <div class="col-12">
                ...
                <div class="col-12 row">
                    <div>
                       ...
                       <li class="breadcrumb-item"><a href="javascript:dh_import();"></a></li>
                    </ol>
                    </div>
            </div>
                    <!--  title   end  -->
                    <!--  ================================上传文件部分 start  ===============================================   -->
                        <div class="form-row  col-12">
                           ...
                           <div class="col-4" style="margin-top:10px;" id="downloadTemplate">
                              <!-- <a href="/excelTemplate/download.asyn?ids=112"> 模板下载</a> -->
                              <a href="#"> 模板下载</a>
                           </div>
                        </div>
                    <!--  ================================上传文件部分  end===============================================   -->
...
<script type="text/javascript">
	$(function(){
		...
		$("#form-upload").on("change",'.file-import',function(){
			...
			if(suffix=="xlsx" || suffix=="xls"){
				...
				$custom.request.ajaxUpload(serverAddr+"/adjustmentInventory/importAdjustment.asyn", formData, function(result){
					if(result.state == '200'){
                        ...
                        $.each(result.data["message"],function(i,d){
                            var tr = "";
                            tr+="<tr><td style='text-align:center;'>"+d.rows+"</td><td>"+d.message+"</td></tr>";
	...
	function dh_list(){
		//$load.a(pageUrl+"3001");
		$module.load.pageOrder("act=10002");
	}
	
	function dh_import(){
		//$load.a(pageUrl+"30014");
		$module.load.pageOrder("act=100021");
	}
	
	//模板下载
/* 	function download(){
		this.location.href="/excelTemplate/download.asyn?ids=112";
	} */
	
	// 模板下载
	$("#downloadTemplate").click(function(){
		$downLoad.downLoadByUrl("/excelTemplate/download.asyn?ids=112");
	})
</script>