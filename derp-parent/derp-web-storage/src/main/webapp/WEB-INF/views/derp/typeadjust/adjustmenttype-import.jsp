...
<script type="text/javascript">
	$(function(){
		...
		$("#form-upload").on("change",'.file-import',function(){
			...
			if(suffix=="xlsx" || suffix=="xls"){
				...
				$custom.request.ajaxUpload(serverAddr+"/adjustmentType/importAdjustment.asyn", formData, function(result){
                    if(result.state == '200'){
	...
	function dh_list(){
		$module.load.pageOrder("act=10001");
	}
	
	function dh_import(){
		$module.load.pageOrder("act=100012");
	}
	
	// 模板下载
	$("#downloadTemplate").click(function(){
		$downLoad.downLoadByUrl("/excelTemplate/download.asyn?ids=135");
	})
</script>