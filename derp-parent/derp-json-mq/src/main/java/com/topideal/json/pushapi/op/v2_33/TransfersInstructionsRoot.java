 ...
 *2018/4/3
 */
public class TransfersInstructionsRoot implements Serializable {
	...
	// 商品列表
	private List<TransfersInstructionsGoodsItem> goodList;
	...
	public List<TransfersInstructionsGoodsItem> getGoodList() {
		return goodList;
	}
	public void setGoodList(List<TransfersInstructionsGoodsItem> goodList) {
