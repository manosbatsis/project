 ...
 *
 */
public class AdjustmentTypeRootJson implements Serializable {
	...
	private List<AdjustmentTypeGoodsListJson> goodsList; // 库存调整详情
	...
	public List<AdjustmentTypeGoodsListJson> getGoodsList() {
		return goodsList;
	}
	public void setGoodsList(List<AdjustmentTypeGoodsListJson> goodsList) {
