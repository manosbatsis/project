 ...
 * @author 杨创
 */
public class SaleReturnFirstTallyGoodsListJson {
	...
	private List<SaleReturnFirstTallyBatchListJson> receiveList;
	...
	public List<SaleReturnFirstTallyBatchListJson> getReceiveList() {
		return receiveList;
	}

	public void setReceiveList(List<SaleReturnFirstTallyBatchListJson> receiveList) {
