 ...
 * @author zhanghx
 */
public class PurchaseStorageDeclareGoodsListJson {
	...
	//采购订单表体Id(拆分报文用，非接口字段)
	private Long purchaseItemId;

	private List<PurchaseStorageDeclareBatchListJson> receiveList;
	...
	public List<PurchaseStorageDeclareBatchListJson> getReceiveList() {
		return receiveList;
	}

	public void setReceiveList(List<PurchaseStorageDeclareBatchListJson> receiveList) {
