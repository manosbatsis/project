package com.topideal.json.pushapi.epass.e04;
 ...
 *2018/5/31
 */
public class TransferOrderRootJson {
	...
	private String serve_types;//01:仓间调拨  02:仓内调拨
	...
	private String recadd;//recadd	收货地址 调出仓库为海外仓，调入仓库为综合仓必填
	...
	private String overseas_shipper;//境外发货人 
	private String destion_code;//目的地代码 HP01-黄埔状元谷 HK01-香港本地 GZJC01-广州机场
	private String receiver_name;//收货人姓名 
	private String receiver_country;//国家 字符串（中文、如：中国）
	/**保税仓调海外仓增加字段*/
	private String re_service_type;//10：退运服务（默认）20：销毁服务 30：跨关区转出转关服务
	private String port_dest_no;//卸货港编码	44011501：南沙新港口岸	
	private String district_type;//是否同关区( 0 :是, 1：否 )
	private String datasource;//  经分销：DISTRIBUTED（经分销此字段必填）
	private String transportbl_no;// 头程提单号 

	private List<TransferGoodsItemJson> good_list;//
	//新增字段
	private String from_store_type; //调出仓库类型
	private String to_store_type; //调入仓库类型
	...
	public List<TransferGoodsItemJson> getGood_list() {
		return good_list;
	}

	public void setGood_list(List<TransferGoodsItemJson> good_list) {
	...
	public String getFrom_store_type() {
		return from_store_type;
	}

	public void setFrom_store_type(String from_store_type) {
		this.from_store_type = from_store_type;
	}

	public String getTo_store_type() {
		return to_store_type;
	}

	public void setTo_store_type(String to_store_type) {
		this.to_store_type = to_store_type;
	}
}
