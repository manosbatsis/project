...
import com.topideal.mapper.BuInventoryItemMapper;
...
public class BuInventoryItemDaoImpl implements BuInventoryItemDao {
	 ...
	 */
	@Override
	public int delBuInventoryItem(Map<String, Object> map) throws SQLException {
		return mapper.delBuInventoryItem(map);
	}
	/**
	 * 事业部库存表体信息
	 */
	...
	public List<BuInventoryItemDTO> getBuInventoryItem(BuInventoryItemDTO dto) throws SQLException {
		return mapper.getBuInventoryItem(dto);
	}
