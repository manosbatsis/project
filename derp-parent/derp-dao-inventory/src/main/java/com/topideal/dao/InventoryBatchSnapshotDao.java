 ...
 *
 */
public interface InventoryBatchSnapshotDao extends BaseDao<InventoryBatchSnapshotModel>{
	 ...
	 * @throws SQLException
	 */
	InventoryBatchSnapshotModel getlistByPage(InventoryBatchSnapshotModel model) throws SQLException;
...
/*	List<InventoryBatchSnapshotModel>countInventoryBatchSnapshotByGoodsStock(InventoryBatchSnapshotModel model) throws Exception;
	*/
	 ...
	 * @throws Exception
	 */
	InventoryBatchSnapshotDTO getListByPage(InventoryBatchSnapshotDTO model) throws SQLException;
