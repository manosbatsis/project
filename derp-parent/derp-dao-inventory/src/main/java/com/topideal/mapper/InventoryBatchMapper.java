...
public interface InventoryBatchMapper extends BaseMapper<InventoryBatchModel> {
	 ...
	 * @throws Exception
	 */
	PageDataModel<InventoryBatchDTO>	selectInventoryWarningByPage(InventoryBatchDTO model ) throws Exception;
	 ...
	 * @throws Exception
	 */
	PageDataModel<InventoryBatchDTO>	listProductInventoryDetailsByPage(InventoryBatchDTO model ) throws Exception;
    ...
    * @throws SQLException
    */
	PageDataModel<InventoryBatchDTO>	 getInventoryBatchByPage(InventoryBatchDTO model) throws SQLException;
	 ...
	 * @return
	 */
	Integer checkDepotIsUse(@Param("depotId")Long depotId);
     ...
     * @throws Exception
     */
	InventoryBatchModel searchInventoryBatchForAdd(InventoryBatchModel inBatchModel);
     ...
     * @return
     */
	List<InventoryBatchModel> getAvailableNum(@Param("merchantId")Long merchantId, @Param("depotId")Long depotId, @Param("goodsId")Long goodsId, @Param("unit")String unit);
	 ...
	 * @throws Exception
	 */
	Map<String, Object> getBadOrExpiredSurplusNum(@Param("merchantId")Long merchantId,@Param("depotId")Long depotId, @Param("goodsId")Long goodsId,@Param("unit")String unit,@Param("type")String type,@Param("isExpire")String isExpire,@Param("batchNo")String batchNo)throws Exception;
	 ...
	 * @return
	 */
	List <InventoryBatchModel>  getBatchValidation(@Param("depotId")Long depotId)throws Exception;
