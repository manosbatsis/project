...
public interface ConsumeMonitorInventoryDao extends BaseDao<ConsumeMonitorInventoryModel>{
	 ...
	 * @throws SQLException
	 */
	ConsumeMonitorInventoryModel getListByMonth(ConsumeMonitorInventoryModel model) throws SQLException;
