...
public interface BuInventorySummaryItemDao extends BaseDao<BuInventorySummaryItemModel> {
	 ...
	 * @throws SQLException
	 */
	List<Map<String, Object>> getBuPurchaseInfos(Long id) throws SQLException;
	// 出库明细
