...
import com.topideal.mapper.system.CostPriceDifferenceMapper;
...
public class CostPriceDifferenceDaoImpl implements CostPriceDifferenceDao {
	...
	@Override
	public List<Map<String, Object>> getCostPriceDifferenceMapList(Map<String, Object> map) throws SQLException {
		return mapper.getCostPriceDifferenceMapList(map);
	}
