...
@MyBatisRepository
public interface BuInventoryMapper extends BaseMapper<BuInventoryModel> {
	 ...
	 * @return
	 */
	List<BuInventoryModel> getBuInventoryByCommbarcode(@Param("month") String month, @Param("buIds") List<Long> buIds) throws SQLException;
