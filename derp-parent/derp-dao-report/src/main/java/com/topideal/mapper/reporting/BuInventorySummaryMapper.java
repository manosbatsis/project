...
@MyBatisRepository
public interface BuInventorySummaryMapper extends BaseMapper<BuInventorySummaryModel> {
	 ...
	 */
	 ...
	 /**
		 ...
		 * @throws SQLException
		 */
	PageDataModel<BuInventorySummaryDTO> getListByPage(BuInventorySummaryDTO model) throws SQLException;
	/**
	 * 查询仓库月汇总报表
	 */
	 ...
	 * @return
	 */
	List<Map<String, Object>> getInWarehouseExport(Map<String, Object> map);
}
