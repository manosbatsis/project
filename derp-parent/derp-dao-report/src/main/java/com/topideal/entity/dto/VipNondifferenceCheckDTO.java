...
public class VipNondifferenceCheckDTO extends PageModel implements Serializable{
    ...
    */
    ...
    this.crawlerTypeLabel = DERP_REPORT.getLabelByKey(DERP_REPORT.vipAutoVeri_BillTypeList, crawlerType);
    }
    ...
    this.orderTypeLabel = DERP_REPORT.getLabelByKey(DERP_REPORT.vipAutoVeri_orderTypeList, orderType);
    }
    /*orderId get 方法 */
