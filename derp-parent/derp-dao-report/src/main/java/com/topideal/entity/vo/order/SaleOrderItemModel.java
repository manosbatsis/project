...
public class SaleOrderItemModel extends PageModel implements Serializable{
    ...
    private Timestamp createDate;
 	...
 	// 工厂编码
  	...
  	//当日销售额(RMB)
  	private String daySaleAmount;
  	//当月销售量
  	private String monthSaleCount;
  	//当月销售额(RMB)
  	private String monthSaleAmount;
  	//当月日均销售量
  	private String monthAvgSaleCount;
  	//品类
  	private String category;
  	//年度销售量
  	private String yearSaleCount;
  	//年度销售额
	...
	public String getDaySaleAmount() {
		return daySaleAmount;
	}
	public void setDaySaleAmount(String daySaleAmount) {
	...
	public String getMonthAvgSaleCount() {
		return monthAvgSaleCount;
	}
	public void setMonthAvgSaleCount(String monthAvgSaleCount) {
		this.monthAvgSaleCount = monthAvgSaleCount;
	}
	public String getYearSaleCount() {
		return yearSaleCount;
	}
	public void setYearSaleCount(String yearSaleCount) {
		this.yearSaleCount = yearSaleCount;
	}
	public String getYearSaleAmount() {
		return yearSaleAmount;
	}
	public void setYearSaleAmount(String yearSaleAmount) {
