...
@ApiModel
public class AdvancePaymentBillDTO extends PageModel implements Serializable{
    ...
    */
    ...
    @ApiModelProperty(value = "操作明细", required = false)
    List<OperateLogDTO> operateList ;
    @ApiModelProperty(value = "付款记录明细", required = false)
    List<AdvancePaymentRecordItemDTO> recordItemList ;
	...
	public List<AdvancePaymentRecordItemDTO> getRecordItemList() {
		return recordItemList;
	}
	public void setRecordItemList(List<AdvancePaymentRecordItemDTO> recordItemList) {
