 ...
 **/
@ApiModel
public class InvoiceTemplateYSDTO implements Serializable {
    ...
    private List<InvoiceTemplateItemYSDTO> itemList;

    @ApiModelProperty("发票详情明细")
    private List<InvoiceTemplateItemDetailsYSDTO>detailsItemList;
    /**
     * 发票总金额
     */
	...
	public List<InvoiceTemplateItemYSDTO> getItemList() {
		return itemList;
	}

	public void setItemList(List<InvoiceTemplateItemYSDTO> itemList) {
		this.itemList = itemList;
	}

	public List<InvoiceTemplateItemDetailsYSDTO> getDetailsItemList() {
		return detailsItemList;
	}

	public void setDetailsItemList(List<InvoiceTemplateItemDetailsYSDTO> detailsItemList) {
