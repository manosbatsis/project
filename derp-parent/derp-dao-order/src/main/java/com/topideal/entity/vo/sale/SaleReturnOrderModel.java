...
public class SaleReturnOrderModel extends PageModel implements Serializable {
	...
	// 表体信息
	private List<SaleReturnOrderItemModel> itemList;
	...
	public List<SaleReturnOrderItemModel> getItemList() {
		return itemList;
	}

	public void setItemList(List<SaleReturnOrderItemModel> itemList) {
