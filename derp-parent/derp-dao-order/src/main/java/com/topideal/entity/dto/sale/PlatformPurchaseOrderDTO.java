...
@ApiModel
public class PlatformPurchaseOrderDTO extends PageModel implements Serializable{
    ...
    @ApiModelProperty(value = "表体数据")
    private List<PlatformPurchaseOrderItemDTO> itemDTOList ;
	...
	public List<PlatformPurchaseOrderItemModel> getItemList() {
		return itemList;
	}
	public void setItemList(List<PlatformPurchaseOrderItemModel> itemList) {
    ...
    public List<PlatformPurchaseOrderItemDTO> getItemDTOList() {
        return itemDTOList;
    }

    public void setItemDTOList(List<PlatformPurchaseOrderItemDTO> itemDTOList) {
