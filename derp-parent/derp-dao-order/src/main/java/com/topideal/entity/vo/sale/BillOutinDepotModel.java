...
public class BillOutinDepotModel extends PageModel implements Serializable{
 ...
 // 当前登录用户绑定的事业部集合
    ...
    //账单出入库单表体
    private List<BillOutinDepotItemModel>itemList;
	...
	public List<BillOutinDepotItemModel> getItemList() {
		return itemList;
	}
	public void setItemList(List<BillOutinDepotItemModel> itemList) {
