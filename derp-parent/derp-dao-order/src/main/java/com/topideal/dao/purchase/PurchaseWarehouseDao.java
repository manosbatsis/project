...
public interface PurchaseWarehouseDao extends BaseDao<PurchaseWarehouseModel>{
	 ...
	 * @return
	 */
	List<PurchaseWarehouseExportDTO> getExportDetails(List ids) throws SQLException;
	 ...
	 * @throws SQLException
	 */
	PurchaseWarehouseDTO getListByPage(PurchaseWarehouseDTO dto) throws SQLException;
	 ...
	 * @throws SQLException
	 */
	List<String> getWarehouseListById(Long id) throws SQLException;
