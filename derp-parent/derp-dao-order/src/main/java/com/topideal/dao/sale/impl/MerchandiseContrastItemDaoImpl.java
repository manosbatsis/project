...
import com.topideal.mapper.sale.MerchandiseContrastItemMapper;
...
public class MerchandiseContrastItemDaoImpl implements MerchandiseContrastItemDao {
    ...
    @Override
    public Long deleteByContrastId(Long id) {
	    return mapper.deleteByContrastId(id);
    }

    @Override
    public List<MerchandiseContrastItemDTO> getContrastItemByContrastId(MerchandiseContrastItemModel contrastItemModel) {
        return mapper.getContrastItemByContrastId(contrastItemModel);
    }
}