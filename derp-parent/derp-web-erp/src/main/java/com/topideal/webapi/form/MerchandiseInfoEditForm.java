 ...
 * @author lchenxing
 */
public class MerchandiseInfoEditForm implements Serializable {
	@ApiModelProperty(value = "令牌",required = true)
	private String token;
	@ApiModelProperty(value = "id新增非必填,修改必填",required = true)
	private Long id;
	...
	@ApiModelProperty(value = "商品一级级分类ID",required = true)
