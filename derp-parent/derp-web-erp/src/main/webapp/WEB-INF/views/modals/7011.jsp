                ...
                <div class="modal-body">
                	...
                	<div class="form-row">
                      ...
                      <div class="form-row mt20">
                      	<div class="form-inline m0auto">
                          		<div class=form-group>
                          			<button type="button" class="btn btn-info waves-effect waves-light fr" onclick='$m7011.save();'>确定</button>
                          			<button type="button" class="btn btn-light waves-effect waves-light ml15"  onclick='$m7011.hide();'>取消</button>
                          		</div>
                          	</div>
                      </div>
                </div>
        ...
        save:function(){
        	...
        	if(ids!=""){
        		if(ids.indexOf(",")!=-1){
		        	...
		        	$custom.request.ajax(
		        		$m7011.params.getListByIdsUrl,{"ids":ids},function(data){
		                	if(data.state==200){
		                        var $tr = "";
        	...
        	$($m7011.params.modalId).modal("hide");
        },
        show:function(){
	        this.list();
	        $($m7011.params.modalId).modal("show");
        },
        hide:function(){
            $($m7011.params.modalId).modal("hide");
        },
