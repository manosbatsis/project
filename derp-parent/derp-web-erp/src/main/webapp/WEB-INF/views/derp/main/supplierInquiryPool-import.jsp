            ...
            <div class="col-12">
                ...
                <div class="col-12 row">
                    <div>
                       ...
                       <li class="breadcrumb-item "><a href="javascript:$load.a('/supplierInquiryPool/toPage.html');">供应商询价池</a></li>
                       <li class="breadcrumb-item"><a href="javascript:$load.a('/supplierInquiryPool/toImportPage.html');">批量导入</a></li>
                    </ol>
                    </div>
            </div>
                    <!--  title   end  -->
	...
	$(function(){
		...
		$("#form-upload").on("change",'.file-import',function(){
			...
			if(suffix=="xlsx" || suffix=="xls"){
				...
				$custom.request.ajaxUpload("/supplierInquiryPool/importSIPool.asyn", formData, function(result){
					if(result.state == '200'){
...
// 	//模板下载
// 	function download(){
// 		this.location.href="/excelTemplate/download.asyn?ids=106";
// 	}
// 模板下载
$("#downloadTemplate").click(function(){
	$downLoad.downLoadByUrl("/excelTemplate/download.asyn?ids=106");
})
