                ...
                <div class="col-12 row">
                    <div>
                       ...
                       <li class="breadcrumb-item"><a href="#">商品档案</a></li>
                        ...
                        <li class="breadcrumb-item "><a href="javascript:$load.a('/merchandise/toImportPage.html');">批量导入</a></li>
                    </ol>
                    </div>
            </div>
                    <!--  title   end  -->
                                    ...
                                    <div class="col-7 mll">
                                      <button type="button" class="btn btn-gradient btn-file" id="btn-file">选择文件</button>
                                    	<form enctype="multipart/form-data" id="form-upload">
                                    		...
                                    		<div>
                                    		    <input type="hidden" name="linshi" id="linshi"  placeholder="输入1走临时导入方案"  vaclass="btn-hidden">                                   		
                                    		</div>
                                    	</form>
                                    </div>
                                </div>
...
$("#file").change(function(){
	...
	if(suffix=="xlsx" || suffix=="xls"){
		...
		$custom.request.ajaxUpload("/merchandise/importMerchandise.asyn", formData, function(result){
			if(result.state == '200'){
...
$("#downloadTemplate").click(function(){
	$downLoad.downLoadByUrl("/excelTemplate/download.asyn?ids=113");
})
