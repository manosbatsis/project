            ...
            <div class="col-12">
                ...
                <div class="col-12 row">
                    <div>
                       ...
                       <li class="breadcrumb-item"><a href="javascript:$load.a('/supplierMerchandisePrice/toImportPage.html');">批量导入</a></li>
                    </ol>
                    </div>
            </div>
                    <!--  title   end  -->
	...
	$(function(){
		...
		$("#form-upload").on("change",'.file-import',function(){
			...
			if(suffix=="xlsx" || suffix=="xls"){
				...
				$custom.request.ajaxUpload("/supplierMerchandisePrice/importSMPrice.asyn", formData, function(result){
					if(result.state == '200'){
...
$("#downloadTemplate").click(function(){
	$downLoad.downLoadByUrl("/excelTemplate/download.asyn?ids=103");
})
