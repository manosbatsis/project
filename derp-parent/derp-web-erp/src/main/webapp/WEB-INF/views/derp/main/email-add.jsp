                ...
                <div>
                   <div class="col-12 row">
                    <div>
                       ...
                       <li class="breadcrumb-item"><a href="javascript:$load.a('/email/toAddPage.html');">邮件提醒新增</a></li>
                    </ol>
                    </div>
            </div>
            	<form id="add-form">
                        ...
                        <div class="form-row">
                         <div class="col-4">
                              <div class="row">
                                  ...
                                  <div class="col-8 ml10">
                                    <input type="text" required="" parsley-type="email" class="form-control" id="accountPeriodDay" name="accountPeriodDay"  >                                     
                                  </div>
                              </div>
                          </div>
                          <div class="col-5">
                              <div class="row">
                                  ...
                                  <div class="col-7 ml10">
                                      <input type="radio"  id="accountUnitType" name="accountUnitType"  value="1"  checked>自然日
                      				  <input type="radio"  id="accountUnitType"  name="accountUnitType"  value="2"  >工作日                                 
                                  </div>
                              </div>
                          </div>
                      </div>
                      <div class="form-row">
                          <div class="col-4">
                              <div class="row">
                                  ...
                                  <div class="col-8 ml10">
                                      <input type="text" required="" parsley-type="email" class="form-control"  id="advanceReminderDay" name="advanceReminderDay"  placeholder="多个用英文逗号隔开" >
                                  </div>
                              </div>
                          </div>
                          <div class="col-5">
                              <div class="row">
                                  ...
                                  <div class="col-7 ml10">
 									<input type="radio"  id="reminderUnitType" name="reminderUnitType"  value="1"  checked>自然日
                      				<input type="radio"  id="reminderUnitType"  name="reminderUnitType"  value="2"  >工作日                                            </div>
                              </div>
                          </div>
                       </div>
...
$module.constant.getConstantListByNameURL.call($('select[name="reminderType"]')[0],"emailConfig_reminderTypeList",null);
$module.constant.getConstantListByNameURL.call($('select[name="baseTimeType"]')[0],"emailConfig_baseTimeTypeList",null);
