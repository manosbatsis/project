                ...
                <div class="col-12 row">
                    <div>
                       ...
                       <li class="breadcrumb-item"><a href="#">客户档案</a></li>
                        ...
                        <li class="breadcrumb-item "><a href="javascript:$load.a('/customerSale/toImportPage.html');">批量导入</a></li>
                    </ol>
                    </div>
            </div>
                    <!--  title   end  -->
...
$("#file").change(function(){
	...
	if(suffix=="xlsx" || suffix=="xls"){
		...
		$custom.request.ajaxUpload("/customerSale/importPriceSale.asyn", formData, function(result){
...
//模板下载
function download(){
	//this.location.href="/excelTemplate/download.asyn?ids=116";
	$downLoad.downLoadByUrl("/excelTemplate/download.asyn?ids=116");
}
</script>