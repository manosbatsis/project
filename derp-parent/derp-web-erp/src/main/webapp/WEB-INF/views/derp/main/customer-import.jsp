            ...
            <div class="col-12">
                ...
                <div class="col-12 row">
                    <div>
                       ...
                       <li class="breadcrumb-item"><a href="javascript:$load.a('/customer/toImportPage.html');">批量导入</a></li>
                    </ol>
                    </div>
            </div>
                    <!--  title   end  -->
...
<!--                               <a href="/excelTemplate/download.asyn?ids=104"> 模版下载</a> -->
									<a href="#">模板下载</a>
                           </div>
                        </div>
                    <!--  ================================上传文件部分  end===============================================   -->
	...
	$(function(){
		...
		$("#form-upload").on("change",'.file-import',function(){
			...
			if(suffix=="xlsx" || suffix=="xls"){
				...
				$custom.request.ajaxUpload("/customer/importCustomer.asyn", formData, function(result){
					if(result.state == '200'){
...
// 	//模板下载
// 	function download(){
// 		this.location.href="/excelTemplate/download.asyn?ids=104";
// 	}

// 模板下载
$("#downloadTemplate").click(function(){
	$downLoad.downLoadByUrl("/excelTemplate/download.asyn?ids=104");
})
