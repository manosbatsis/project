                ...
                <div>
                   <div class="col-12 row">
                    <div>
                       ...
                       <li class="breadcrumb-item "><a href="javascript:$load.a('/external/toAddPage.html');">新增配置信息</a></li>
                    </ol>
                    </div>
                   </div>
                    <!--  title   end  -->               
                    ...
                    <div class="col-5">
                        <div class="row">
                            ...
                            <div class="col-8 ml10 line">
                                <input type="text" required="" parsley-type="text" class="form-control" placeholder="使用对象" name="useObject">
                            </div>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="row">
                            ...
                            <div class="col-8 ml10 line">
                                <input type="text" required="" parsley-type="text" class="form-control" placeholder="配置名称"  name="name">
                            </div>
                        </div>
                    </div>
                </div>   
                  <div class="form-row mt20 ml15">
                    <div class="col-5">
                        <div class="row">
                            ...
                            <div class="col-8 ml10 line">
                                <input type="text" required="" parsley-type="text" class="form-control"  placeholder="配置key" name="key">
                            </div>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="row">
                            ...
                            <div class="col-8 ml10 line">
                                <input type="text" required="" parsley-type="text" class="form-control" placeholder="值" name="value">
                            </div>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript">
	$(function(){
		...
		$("#save-buttons").click(function(){
			var url = "/external/saveExternal.asyn";	
