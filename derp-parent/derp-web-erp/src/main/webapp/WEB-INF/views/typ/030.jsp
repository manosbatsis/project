                ...
                <div class="col-12 row">
                    ...
                    <!--  title   end  -->
                      ...
                      <div class="form-row">
                          ...
                          <div class="col-3">
                              <div class="row">
                                  <label class="col-6 col-form-label"><div class="fr">交运时间<span>：</span></div></label>
                                  <div class="col-6 ml10">
                                        <input type="text" required="" parsley-type="text" class="form-control" name="goodsNo">
                                  </div>
                              </div>
                      ...
                      <div class="row col-12 mt20">
                        <div class="button-list">
                            ...
                            <button type="button" class="btn btn-add waves-effect waves-light btn-sm">导入出库账单明细</button>
                        </div>
                    </div>     
                      <!--  ================================表格 ===============================================   -->
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered" cellspacing="0" width="100%">
                        ...
                        <tr>
                            ...
                            <th style="white-space:nowrap;" class="tc">出库清单编号</th>
                            ...
                            <th style="white-space:nowrap;" class="tc">销售类型</th>
                            <th style="white-space:nowrap;" class="tc">销售订单编号</th>
                            <th style="white-space:nowrap;" class="tc">收件人</th>
                            <th style="white-space:nowrap;" class="tc">运单号</th>
                            <th style="white-space:nowrap;" class="tc">交运时间</th>
                            <th style="white-space:nowrap;" class="tc">出库状态</th>
