                ...
                <div class="col-12 row">
                    ...
                    <!--  title   end  -->
                      <div class="form-row" >
                          ...
                          <div class="col-3">
                              <div class="row">
                                  <label class="col-6 col-form-label"><div class="fr">客       户<span>：</span></div></label>
                                  <div class="col-6 ml10">
                                      <input class="form-control" />
                                  </div>
                              </div>
                          ...
                          <div class="col-3 ml15">
                              <div class="row">
                                  <label class="col-5 col-form-label"><div class="fr">仓      库<span>：</span></div></label>
                      ...
                      <div class="form-row">
                          ...
                          <div class="col-3 ml15">
                              <div class="row">
                                  <label class="col-5 col-form-label"><div class="fr">海关状态<span>：</span></div></label>
                                  <div class="col-7 ml10">
                                           <select  class="form-control" >
                                      		<option>请选择</option>
                                      </select>
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered" cellspacing="0" width="100%">
                        ...
                        <tr>
                            ...
                            <th style="white-space:nowrap;" class="tc">收件电话</th>
                            <th style="white-space:nowrap;" class="tc">海关状态</th>
                            <th style="white-space:nowrap;" class="tc">国检状态</th>
