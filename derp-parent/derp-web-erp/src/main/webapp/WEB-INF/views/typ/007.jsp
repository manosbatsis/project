                   ...
                   <div class="col-12 row">
                    <div>
                       ...
                       <li><i class="dripicons-location"></i> 当前位置：</li>
                        <li class="breadcrumb-item"><a href="#">设置库存预警</a></li>
                    </ol>
                    </div>
            </div>
                    <!--  title   end  -->
                      <div class="form-row mt20">
                          <div class="col-3">
                              <div class="row">
                                  <label  class="col-5 col-form-label "><div class="fr">唯一标识<span>：</span></div></label>
                       ...
                       <div class="form-row mt20">
                          ...
                          <div class="col-5">
                              <div class="row">
                                  <label class="col-4 col-form-label"  style="white-space:nowrap;"><div class="fr">计量单位<span>：</span></div></label>
                                  <div class="col-7 ml10">
                                      <input type="text" required="" parsley-type="text" class="form-control" name="barcode">
                                  </div>
                              </div>
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered" cellspacing="0" width="100%">
                        ...
                        <tr>
                            ...
                            <th style="white-space:nowrap;" class="tc">库房</th>
                            <th style="white-space:nowrap;" class="tc">最低库存</th>
                            <th style="white-space:nowrap;" class="tc">最高库存</th>
