                ...
                <div class="col-12 row">
                    <div>
                       ...
                       <li><i class="dripicons-location"></i> 当前位置：</li>
                        <li class="breadcrumb-item"><a href="#">供应商询价池</a></li>
                    </ol>
                    </div>
            </div>
                    <!--  title   end  -->
                      <div class="form-row" >
                          ...
                          <div class="col-4">
                              <div class="row">
                                  <label  class="col-5 col-form-label "><div class="fr">供应商选择<span>：</span></div></label>
                          ...
                          <div class="col-3">
                              <div class="row">
                                  <label class="col-6 col-form-label"><div class="fr">品牌<span>：</span></div></label>
                      ...
                      <div class="form-row">
                          ...
                          <div class="col-3">
                              <div class="row">
                                  <label class="col-6 col-form-label"><div class="fr">品类<span>：</span></div></label>
                                  <div class="col-6 ml10">
                                        <input type="text" class="form-control" >
                                  </div>
                              </div>
                          ...
                          <div class="col-3">
                              <div class="row">
                                  <label class="col-5 col-form-label"><div class="fr">原产国<span>：</span></div></label>
                                  <div class="col-7 ml10">
                                           <input type="text" class="form-control" >
                                  </div>
                              </div>
                      ...
                      <div class="row col-12 mt20">
                        <div class="button-list">
                            ...
                            <button type="button" class="btn btn-add waves-effect waves-light btn-sm">批量导出</button>
                        </div>
                    </div>     
                      <!--  ================================表格 ===============================================   -->
