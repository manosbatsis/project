                ...
                <div class="col-12 row">
                    <div>
                       ...
                       <li><i class="dripicons-location"></i> 当前位置：</li>
                        <li class="breadcrumb-item"><a href="#">调拨入库</a></li>
                    </ol>
                    </div>
            </div>
                    <!--  title   end  -->
                      ...
                      <div class="form-row">
                          ...
                          <div class="col-3">
                              <div class="row">
                                  <label  class="col-6 col-form-label "><div class="fr">单据来源<span>：</span></div></label>
                                  <div class="col-6 ml10">
                                       <select  class="form-control" >
                                      		<option></option>
                                      </select>
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered" cellspacing="0" width="100%">
                        ...
                        <tr>
                            ...
                            <th style="white-space:nowrap;" class="tc">调拨入库数量</th>
                            <th style="white-space:nowrap;" class="tc">单据状态</th>
                            <th style="white-space:nowrap;" class="tc">调入时间</th>
