                ...
                <div class="col-12 row">
                    ...
                    <!--  title   end  -->
                      <div class="form-row" >
                          ...
                          <div class="col-3">
                              <div class="row">
                                  <label  class="col-6 col-form-label "><div class="fr">采购订单编号<span>：</span></div></label>
                          ...
                          <div class="col-3">
                              <div class="row">
                                  <label class="col-6 col-form-label"><div class="fr">入仓仓库<span>：</span></div></label>
                                  <div class="col-6 ml10">
                          ...
                          <div class="col-3 ml15">
                              <div class="row">
                                  <label class="col-5 col-form-label"><div class="fr">供  应 商<span>：</span></div></label>
                      ...
                      <div class="form-row">
                          <div class="col-3">
                              <div class="row">
                                  <label  class="col-6 col-form-label "><div class="fr">预计到港时间<span>：</span></div></label>
                                  <div class="col-6 ml10">
                          ...
                          <div class="col-3 ml15">
                              <div class="row">
                                  <label class="col-5 col-form-label"><div class="fr">PO号<span>：</span></div></label>
                                  <div class="col-7 ml10">
                                           <input type="text" class="form-control" >
                                  </div>
                              </div>
                      ...
                      <div class="row col-12 mt20">
                        <div class="button-list">
                            ...
                            <button type="button" class="btn btn-add waves-effect waves-light btn-sm" onclick="$custom.request.delChecked('/merchandise/delMerchandise.asyn');">提交</button>
                            <button type="button" class="btn btn-add waves-effect waves-light btn-sm">导出</button>
                            <button type="button" class="btn btn-add waves-effect waves-light btn-sm">取消</button>
                        </div>
                    </div>     
                      <!--  ================================表格 ===============================================   -->
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered" cellspacing="0" width="100%">
                        ...
                        <tr>
                            ...
                            <th style="white-space:nowrap;" class="tc">入仓单号</th>
