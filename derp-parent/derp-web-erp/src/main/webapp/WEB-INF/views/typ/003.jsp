           ...
           <div class="col-12">
              <div class="card-box table-responsive" >
                      <div class="form-row mt20">
                          <div class="col-3">
                              <div class="row">
                                  <label  class="col-5 col-form-label "><div class="fr">选择仓库<span>：</span></div></label>
                                  <div class="col-7 ml10">
                                      <input type="text" required="" parsley-type="email" class="form-control" name="goodsCode">
                                  </div>
                              </div>
                          </div>
                          <div class="col-5">
                              <div class="row">
                                  <label class="col-4 col-form-label"  style="white-space:nowrap;"><div class="fr">商品选择<span>：</span></div></label>
                                  <div class="col-7 ml10">
                                      <input type="text" required="" parsley-type="email" class="form-control" name="barcode">
                                  </div>
                              </div>
                          </div>
                      ...
                      <div class="ml10 page-title col-12 borderb">
                          <div class="ml10"><div class="checkbox">
