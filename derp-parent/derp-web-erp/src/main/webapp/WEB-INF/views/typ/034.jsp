                ...
                <div class="col-12 row">
                    <div>
                       ...
                       <li><i class="dripicons-location"></i> 当前位置：</li>
                        <li class="breadcrumb-item"><a href="#">调拨理货单</a></li>
                    </ol>
                    </div>
            </div>
                    <!--  title   end  -->
                      <div class="form-row" >
                          ...
                          <div class="col-3 ml15">
                              <div class="row">
                                  <label class="col-5 col-form-label"><div class="fr">合同号<span>：</span></div></label>
                      ...
                      <div class="form-row">
                          <div class="col-3">
                              <div class="row">
                                  <label  class="col-6 col-form-label "><div class="fr">理货单号<span>：</span></div></label>
                                  <div class="col-6 ml10">
                          ...
                          <div class="col-3">
                              <div class="row">
                                  <label class="col-6 col-form-label"><div class="fr">理货日期<span>：</span></div></label>
                                  <div class="col-6 ml10">
                                        <input type="text" required="" parsley-type="text" class="form-control" name="goodsNo">
                                  </div>
                              </div>
                          ...
                          <div class="col-3">
                              <div class="row">
                                  <label  class="col-6 col-form-label "><div class="fr">理货单状态<span>：</span></div></label>
                                  <div class="col-6 ml10">
                                      <input type="text" required="" parsley-type="text" class="form-control" name="goodsNo">
                                  </div>
                              </div>
                      ...
                      <div class="row col-12 mt20">
                        <div class="button-list">
                            <button type="button" class="btn btn-add waves-effect waves-light btn-sm">确认</button>
                            <button type="button" class="btn btn-add waves-effect waves-light btn-sm">驳回</button>
                        </div>
                    </div>     
                      <!--  ================================表格 ===============================================   -->
