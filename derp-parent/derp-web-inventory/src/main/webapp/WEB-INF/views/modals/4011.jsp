...
<script type="text/javascript">
        		...
        		$m4011.params.getListByIdsUrl,{"ids":ids},function(data){
                	if(data.state==200){
                        ...
                        $.each(data.data,function(index,event){
                            ...
                            "<td style='text-align:center'><input type='text' name='contractNo' style='width:70px;text-align:center;' value=' '></td>"+
                            ...
                            "<td style='text-align:center'><input type='text' name='num' style='width:70px;text-align:center;' class='goods-num' value='0' onkeyup='value=value.replace(/[^\d^\.]/g,'')'></td>"+
    ...
    $mytable.params={
        ...
        {data:'goodsCode'},{data:'name'},{data:'goodsNo'},{data:'brandId'},
        ],
