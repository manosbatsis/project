                          ...
                          if(outOrInDepotId=='outDepotId'){//调出
					             ...
					             $.each(data.data,function(index,event){
					                    tr+='<tr>'+
					                           ...
					                           '</td>'+ 
					                           '<td><input type="hidden"  class="form-control" name="outGoodsId" value="'+event.id+'">'+(event.goodsCode==null?'':event.goodsCode)+'</td>'+ 
						                       ...
						                       '<td>'+(event.goodsNo==null?'':event.goodsNo)+'</td>'+ 
						                       '<td>'+(event.name==null?'':event.name)+'</td>'+
						                       '<td><input type="text"  class="form-control" name="transferNum" onkeyup="value=value.replace(/[^\\d]/g,\'\')"></td>'+
						                       '<td><input type="text"  class="form-control" name="brandName" value="'+(event.brandName==null?'':event.brandName)+'" readonly="readonly"></td>'+
											   '<td><input type="text"  class="form-control" name="price" onkeyup="value=value.replace(/[^\\d.]/g,\'\')"></td>'+
											   '<td><input type="text"  class="form-control" name="grossWeight" value="'+(event.grossWeight==null?'':event.grossWeight)+'"></td>'+
											   '<td><input type="text"  class="form-control" name="netWeight" value="'+(event.netWeight==null?'':event.netWeight)+'"></td>'+
                               ...
                               //更新调入三个单元格
                               var td = '<td><input type="hidden"  class="form-control" name="inGoodsId" value="'+event.id+'">'+(event.goodsNo==null?'':event.goodsNo)+
					                      '<button type="button" class="btn btn-add waves-effect waves-light" onclick="$m3011.init(this,\'inDepotId\');">选择商品</button>'+
					                    '</td>';
                               $(thisObj).parent("td").next().replaceWith('<td>'+(event.goodsCode==null?'':event.goodsCode)+'</td>');
