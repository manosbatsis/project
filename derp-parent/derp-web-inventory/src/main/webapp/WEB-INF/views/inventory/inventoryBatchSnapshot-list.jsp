                ...
                <div class="card-box">
                    <div class="col-12 row">
                        <div>
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item "><a href="javascript:list();">库存批次快照列表</a></li>
                            </ol>
                        </div>
                    </div>
                    <!--  title   end  -->
                    ...
                    <div class="row col-12 mt20">
                        <div class="button-list">
                            <shiro:hasPermission name="inventoryBatchSnapshot_exportBatchSnapshot">
...
<script type="text/javascript">
    $(document).ready(function() {
       ...
       $("#depotId").val(depotId);
        ...
        //配置表格参数
        $mytable.params={
            url: serverAddr+'/inventoryBatchSnapshot/listInventoryBatchSnapshot.asyn?r='+Math.random(),
            columns:[{ //复选框单元格
                ...
                {data:'merchantName'},{data:'depotName'},{data:'goodsNo'},{data:'goodsName'},{data:'barcode'},{data:'brandName'},{data:'batchNo'},{data:'productionDate'},{data:'overdueDate'},
                {data:'surplusNum'},{data:'availableNum'},
                {data:'typeLabel'},{data:'isExpireLabel'},{data:'unitLabel'},{data:'lpn'},{data:'createDate'},
            ],
            formid:'#form1'
        };
        //生成列表信息
    ...
    function list(){
        $module.load.pageInventory("bls=6014");
    }
    ...
    $("#exportInventoryBatch").on("click",function(){
        ...
        $custom.alert.warning("确定导出筛选的数据？",function(){
           var url=serverAddr+"/inventoryBatchSnapshot/exportInventoryBatchSnapshotModelMap.asyn?depotId="+depotId+"&goodsNo="+goodsNo+"&batchNo="+batchNo+"&snapshotDate="+snapshotDate;
           //window.open(url);
