            ...
            <div class="col-12">
                ...
                <div class="col-12 row">
                    <div>
                       ...
                       <li class="breadcrumb-item"><a href="javascript:dh_list();">销售目标列表</a></li>
...
<script type="text/javascript">
	$(function(){
		...
		$("#form-upload").on("change",'.file-import',function(){
			...
			if(suffix=="xlsx" || suffix=="xls"){
				...
				$custom.request.ajaxUpload(serverAddr+"/saleTarget/importSaleTarget.asyn", formData, function(result){
					$(".popupbg").hide();
					if(result.state == '200'){
	...
	$("#downloadTemplate").click(function(){
		$downLoad.downLoadByUrl("/excelTemplate/download.asyn?ids=137");
	})
</script>