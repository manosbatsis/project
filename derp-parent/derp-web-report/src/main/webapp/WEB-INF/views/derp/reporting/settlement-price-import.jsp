                ...
                <div class="col-12 row">
                    <div>
                       ...
                       <li class="breadcrumb-item"><a href="#">标准成本单价管理</a></li>
							                      ...
							                      <li class="breadcrumb-item"><a href="javascript:$module.load.pageReport('act=13005');">标准成本单价导入</a></li>
                    </ol>
                    </div>
            </div>
                    <!--  title   end  -->
...
$("#file").change(function(){
	...
	if(suffix=="xlsx" || suffix=="xls"){
		...
		$custom.request.ajaxUpload(serverAddr+"/settlementPrice/importPrice.asyn", formData, function(result){
			if(result.state == '200'){
			...
			$.each(result.data["message"],function(i,d){
				var tr = "";
				var rows = (d.rows==null||d.rows==undefined)?"":d.rows;
				tr+="<tr><td style='text-align:center;'>"+rows+"</td><td style='text-align:center;'>"+d.message+"</td></tr>";
...
//模板下载
function download(){
	$downLoad.downLoadByUrl("/excelTemplate/download.asyn?ids=117");
}
</script>