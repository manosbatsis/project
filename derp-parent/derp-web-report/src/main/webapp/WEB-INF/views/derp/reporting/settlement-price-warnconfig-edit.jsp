...
<div class="content">
    <div class="container-fluid mt80">
        <!-- Start row -->
                ...
                <div>
                   <div class="col-12 row">
                    <div>
                       ...
                       <li class="breadcrumb-item"><a href="javascript:$load.a('/settlementPriceWarnconfig/toEditPage.html');">单价预警配置编辑</a></li>
                    </ol>
                    </div>
            </div>
            	<form id="add-form">
                          ...
                          <div class="col-4">
                              <div class="row">
                               <input type="hidden" required="" parsley-type="email" class="form-control"  id="id" name="id" value="${detail.id }">                                  
                                  ...
                                  <div class="col-7 ml10">
                                      <input type="text" required="" class="form-control" id="waveRange" name="waveRange"  value="${detail.waveRange}">               
                                  </div>
                      ...
                      <div class="form-row">
                          <div class="col-4">
                              <div class="row">
                                  ...
                                  <div class="col-8 ml10">
                                        <input type="text" required="" class="form-control" id="emailTitle" name="emailTitle"  value="${detail.emailTitle}">       
                                  </div>
                              </div>
                          </div>
                          <div class="col-5"></div>
                              ...
                              <div class="row">
                                  ...
                                  <div class="col-8 ml10">
                                   <shiro:hasPermission name="settlement_price_warnconfig_toAddPage">
		                                <button type="button" class="btn btn-find waves-effect waves-light btn-sm" id="chooseUser" onclick="$m18012.init()">选择用户</button>
		                            </shiro:hasPermission>
                                        <textarea style="width: 800px;height:260px;word-break: break-all;" id="receiverEmail">${detail.receiverEmail }</textarea>
                                        <input type="hidden"  id="receiverId" name="receiverId"  value="${detail.receiverId }"/>
                                        <input type="hidden"  id="receiverName" name="receiverName" value="${detail.receiverName }"/>
                                  </div>
                              </div>
                          </div>
                      </div>
          ...
          <!--======================Modal框===========================  -->
            <!-- 授予用户 -->
            <jsp:include page="/WEB-INF/views/modals/18012.jsp" />
        </div>
        <!-- container -->
    </div>
...
var buIdVal = "${detail.buId}";
if(userType!=1){
	//事业部
	$module.businessUnit.getSelectBeanByMerchantDepotRel.call($("select[name='buId']")[0],buIdVal,null, null,null);
}
var merchantId=$("select[name='merchantId']").val();
//加载事业部
 $module.businessUnit.getSelectBeanByMerchantDepotRel.call($("select[name='buId']")[0],buIdVal,merchantId,null,null);
	$(function(){
		...
		$("#save-buttons").click(function(){
			var url = serverAddr+"/settlementPriceWarnconfig/modifySettlementPriceWarnconfig.asyn";
