			...
			<div class="col-12">
				<div class="card-box">
					...
					<ul class="nav nav-tabs">
						<li class="nav-item">
							<a href="#" data-toggle="tab" class="nav-link" onclick="$module.load.pageReport('act=19001');">销售类型达成</a>
						</li>
						<li class="nav-item">
							<a href="#" data-toggle="tab" class="nav-link" onclick="$module.load.pageReport('act=19002');">电商平台达成</a>
						</li>
						<li class="nav-item">
							<a href="#" data-toggle="tab" class="nav-link active" onclick="$module.load.pageReport('act=19003');">店铺计划达成</a>
						</li>
	           		</ul>
                        ...
                        <table id="datatable-buttons" class="table table-striped dataTable no-footer" cellspacing="0"  width="100%" >
                            <thead>
								<tr>
									...
									<th>商品名称</th>
									<th>标准品牌</th>
									<c:forEach items="${ titleList}" var="platform">
										<th>${platform } / 完成率</th>
									</c:forEach>
								</tr>
							</thead>
	...
	$(document).ready(function() {
        ...
        $mytable.params={
            ...
            /* 每一列的数据 */
                ...
                {data:'brandParent'},
                <c:forEach items="${ titleList}" var="shopName">
	                { 
	                	data: null,
	                	render: function (data, type, row, meta) {
	                		let html = "" ;
	                		
	                		let num = row.${shopName}_num ;
	                		let rate = row.${shopName}_rate ;
