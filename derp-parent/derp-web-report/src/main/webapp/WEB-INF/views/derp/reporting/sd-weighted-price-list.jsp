                ...
                <div class="card-box">
                    <div class="col-12 row">
                        <div>
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="#">SD加权单价列表</a></li>
                            </ol>
                        </div>
                    </div>
                    <form id="form1">
                        <div class="form_box">
                            <div >
                                <div class="form_item h35">
                                    <span class="msg_title">标准条形码 :</span>
                                    <input type="text" parsley-type="text" class="input_msg" id="barcode" name="commbarcode">
                                    ...
                                    <input type="text" required="" parsley-type="text" class="input_msg date-input" name="effectiveMonth" id="effectiveMonth">
                                    <div class="fr">
                                        <button type="button" class="btn ml15 btn-find waves-effect waves-light btn_default" onclick='$mytable.fn.reload();'>查询
                                        </button>
                    ...
                    <div class="row col-md-12 mt20">
                      <div class="button-list">
                            <shiro:hasPermission name="sd_weightedPrice_export">
                                <input type="button" class="btn btn-find waves-effect waves-light btn-sm" onclick="exportSDWeightedPrice();" value="导出"/>
                            </shiro:hasPermission>
                        </div>
                    </div>
                   <%--表格--%>
                        ...
                        <table id="datatable-buttons" class="table table-striped" cellspacing="0" width="100%">
                            <thead>
                                <tr>
                                    ...
                                    <th>标准条码</th>
                                    <th>标准品牌</th>
                                    <th style="width: 50px;">结算币种</th>
                                    <th style="width: 70px;">SD加权单价</th>
                                    <th style="width: 50px;">生效年月</th>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        //配置表格参数
        $mytable.params = {
            url: serverAddr + '/SDweightedPrice/listSDPrice.asyn?r=' + Math.random(),
            columns: [{ //复选框单元格
    ...
    //导出
    function exportSDWeightedPrice() {
        var param = $("#form1").serialize();
        $custom.alert.warning("确定导出？",function(){
            var url = serverAddr+"/SDweightedPrice/sdexportWeightedPrice.asyn?"+param;
