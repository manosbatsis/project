            ...
            <div class="col-12">
                ...
                <div class="col-12 row">
                    <div>
                       ...
                       <li class="breadcrumb-item"><a href="javascript:dh_list();">月度销售额目标</a></li>
                       <li class="breadcrumb-item"><a href="javascript:dh_import();">导入</a></li>
                    </ol>
                    </div>
            </div>
                    <!--  title   end  -->
...
<script type="text/javascript">
	$(function(){
		...
		$("#form-upload").on("change",'.file-import',function(){
			...
			if(suffix=="xlsx" || suffix=="xls"){
				...
				$custom.request.ajaxUpload(serverAddr+"/saleAmountTarget/importAmountTarget.asyn", formData, function(result){
					$(".popupbg").hide();
					if(result.state == '200'){
	...
	function dh_list(){
		$module.load.pageReport("act=18004");
	}
	...
	$("#downloadTemplate").click(function(){
		$downLoad.downLoadByUrl("/excelTemplate/download.asyn?ids=145");
	})
</script>