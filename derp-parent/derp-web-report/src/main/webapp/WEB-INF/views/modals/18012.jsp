            ...
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <div class="form-group account-btn text-center m-t-10">
                        <div class="col-12">
                            <button class="btn w-lg btn-rounded btn-primary waves-effect waves-light" type="button" onclick="$m18012.add();">确认</button>
                            <button class="btn w-lg btn-rounded btn-primary waves-effect waves-light" type="button" onclick="$m18012.hide();">取消</button>
                        </div>
                    </div>
                </div>
            </div><!-- /.modal-content -->
...
<script type="text/javascript">
    ...
    var $m18012={
        ...
        add:function(){
			...
			var emailStr=$("#receiverEmail").val();
			var userIdStr=$("#receiverId").val();
			var userNameStr=$("#receiverName").val();
        ...
        show:function(){
            $($m18012.params.modalId).modal("show")
        },
        hide:function(){
            $($m18012.params.modalId).modal("hide");
        },
        params:{
            url:'',
