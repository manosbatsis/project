                ...
                <div class="card-box">
                    ...
                    <ul class="nav nav-tabs">
                        <shiro:hasPermission name="shelf_list">
                            <li class="nav-item">
                                <a href="#" data-toggle="tab" class="nav-link" onclick="$module.load.pageOrder('act=40041');">上架单</a>
                            </li>
                        </shiro:hasPermission>
                        <shiro:hasPermission name="shelf_idepotList">
                            <li class="nav-item">
                                <a href="#" data-toggle="tab" class="nav-link active" onclick="$module.load.pageOrder('act=40042');">上架入库单</a>
                            </li>
                        </shiro:hasPermission>
                    </ul>
                    ...
                    <form id="form1" >
                        <div class="form_box">
                            <div class="form_con">
                                ...
                                <div class="form_item h35">
                                    <span class="msg_title">上架入库单号 :</span>
                                    <input type="text" required="" parsley-type="text" class="input_msg" name="code">
                                    <span class="msg_title">PO号 :</span>
                                    <input type="text" required="" parsley-type="text" class="input_msg" name="poNos">
                                ...
                                <div class="form_item h35">
                                    <span class="msg_title">销售出库单 :</span>
                                    <input type="text" required="" parsley-type="text" class="input_msg" name="saleOutCode">
...
$module.constant.getConstantListByNameURL.call($('select[name="state"]')[0],"saleShelfIdepot_statusList",null);
function showHideCode(obj){
    ...
    $(document).ready(function() {
        ...
        //配置表格参数
        $mytable.params={
            url:serverAddr+'/saleShelfIdepot/listSaleShelfIdepot.asyn?r='+Math.random(),
            columns:[
                {data:'code1'},{data:'code'},{data:'saleOrderCode'},{data:'saleOutCode'},{data:'inDepotName'},{data:'buName'},{data:'outDepotName'},{data:'poNo'},{data:'stateLabel'},{data:'shelfDate'},
                { //操作
                    orderable: false,
                    width:70,
                    data: null,
    ...
    //详情
    function details(id){
        $module.load.pageOrder("act=40101&id=" + id);
    }
    ...
    $("#exportOrder").on("click",function(){
        ...
        $custom.request.ajax(serverAddr+"/saleShelfIdepot/getOrderCount.asyn", form, function(data){//判断导出的数量是否超出1W
        	if(data.state==200){
        		...
        		//导出数据
            	var url = serverAddr+"/saleShelfIdepot/exportSaleShelfIdepot.asyn";
        		var i =0;
            	if(!!form){
           		    for(var key in form){
           		    	if(i==0){
