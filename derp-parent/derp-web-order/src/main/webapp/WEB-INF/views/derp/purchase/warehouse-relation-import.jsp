            ...
            <div class="col-12">
                ...
                <div class="col-12 row">
                    <div>
                       ...
                       <li class="breadcrumb-item"><a href="javascript:dh_import();">关联采购单导入</a></li>
                    </ol>
                    </div>
            </div>
                    <!--  title   end  -->
...
<script type="text/javascript">
	$(function(){
		...
		$("#file").change(function(){
			...
			if(suffix=="xlsx" || suffix=="xls"){
				...
				$custom.request.ajaxUpload(serverAddr+"/warehouse/importRelation.asyn", formData, function(result){
					$(".popupbg").hide();
					if(result.state == '200'){
	...
	//模板下载
	function download(){
		this.location.href="/excelTemplate/download.asyn?ids=108";
	}
