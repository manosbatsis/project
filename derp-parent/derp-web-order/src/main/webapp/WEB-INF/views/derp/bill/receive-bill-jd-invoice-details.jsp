                                ...
                                <div>
                                    ...
                                    <table class="pure-table pure-table-bordered">
                                        <tr style="text-align:center;">
                                            <td colspan="6">
                                                ${merchantInfo.englishName} ${merchantInfo.fullName}
                                                <input type="hidden" name="detail.merchantInvoiceName" value="${merchantInfo.englishName}&nbsp;${merchantInfo.fullName}">
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td style="width:150px;">
                                                <input type="text" id="poNo" name="detail.purchaseOrder" value="${poNos}" required reqMsg="Purchase Order不能为空！">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="5" style="text-align: right">
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="5">
                                                AVE DA PRAIA GRANDE NO.101,MACAU
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style=" text-align: left">
