...
<div class="content">
    <div class="container-fluid mt80">
        <!-- Start row -->
          <form id="add-form" action="" name="form1" onsubmit>
          <div class="row">
           <div class="col-12">
              <div class="card-box" >
                                         <!--  title   start  -->
                    ...
                    <div class="edit_box">
                        <div class="edit_item">
                            <label class="edit_label"><i class="red">*</i>平台名称：</label>
                             <input type="text" required="" parsley-type="text" class="edit_input" name="platformName" id="platformName" >
                        </div>
                        <div class="edit_item">
                            <label class="edit_label"><i class="red">*</i>平台用户名：</label>
                            <input type="text" required="" parsley-type="text" class="edit_input" name="platformUsername" id="platformUsername">
                        </div>
                    ...
                    <div class="edit_box">
                     ...
                     <div class="edit_box">
                        <div class="edit_item">
                            ...
                            <input type="text" required="" parsley-type="text" class="edit_input" name="crawlerGoodsNo" id="crawlerGoodsNo">
                        </div>
                         <div class="edit_item">
                             <label class="edit_label"><i class="red">*</i>爬虫商品名称：</label>
                             <input type="text" required="" parsley-type="text" class="edit_input" name="crawlerGoodsName" id="crawlerGoodsName">
                         </div>
                    </div>
                    <div class="edit_box">
                        <div class="edit_item">
                        ...
                        <table id="table-list" class="table table-striped">
                            ...
                            <c:forEach items="${saleOrderItemList}" var="item">
                                <tr>
                                    ...
                                    <td><input type='text' name='num' style='width:70px;text-align:center;' class='num' value="${item.num}"  onkeyup="value=value.replace(/[^\d]/g,'')"></td>
                                    <td><input type='text' name='price' class='price' style='width:100px;text-align:center;' value='<fmt:formatNumber value="${item.price}" pattern="#.#####" minFractionDigits="5" />'  ></td>
...
$(document).ready(function () {
    ...
    $module.constant.getConstantListByNameURL.call($('select[name="type"]')[0],"merchandiseContrast_typeList",null);
    //加载公司
    $module.merchant.loadSelectData.call($('select[name="merchantId"]')[0]);
...
function getGoods(){
    ...
    // var url = serverAddr+"/contrast/getByMerchantAndGoodsNo.asyn";
