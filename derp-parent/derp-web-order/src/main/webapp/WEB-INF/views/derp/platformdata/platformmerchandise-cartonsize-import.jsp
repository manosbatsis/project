            ...
            <div class="col-12">
                ...
                <div class="col-12 row">
                    <div>
                       ...
                       <li class="breadcrumb-item"><a href="javascript:$module.load.pageOrder('act=210003');">箱规导入</a></li>
                    </ol>
                    </div>
            </div>
                    <!--  title   end  -->
...
<script type="text/javascript">
	$(function(){
		...
		$("#form-upload").on("change",'.file-import',function(){
            ...
            var uploadUrl = serverAddr+"/platformMerchandise/cartonSizeImport.asyn";
    ...
    $("#downloadTemplate").click(function(){
        $downLoad.downLoadByUrl("/excelTemplate/download.asyn?ids=147");
    })
</script>