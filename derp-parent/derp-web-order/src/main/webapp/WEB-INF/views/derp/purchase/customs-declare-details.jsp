                            ...
                            <div>
                                <div class="col-12 row">
                                    <div>
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item"><a href="#">清关资料详情</a></li>
                                        </ol>
                                    </div>
                                </div>
                                <!--  title   end  -->
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane fade show active" id="contract">
                                        ...
                                        <div class="datum_head_right">
                                            <span>签订日期：</span>
                                            <span class="datum_head_right_con"><fmt:formatDate value="${detail.signingDate}" pattern="yyyy-MM-dd"/></span>
                                        </div>
                                        <div class="datum_head_right">
                                            <span>签订地点：</span>
                                            <span class="datum_head_right_con">${detail.signingAddr }</span>
                                        </div>
                                        ...
                                        <div class="datum_head_left">
                                            <span>甲方地址：</span>
                                            ${detail.firstPartyAddr }
                                        </div>
                                        <div class="datum_head_left">
                                            <span>乙方：</span>
                                            ${detail.secondParty }
                                        </div>
                                        <p>基于甲方与 ${detail.secondParty } 签订的编号为 ${detail.contractNo }的《委托服务协议》（下称“《委托服务协议》”），甲方现委托乙方办理如下商品在中国南沙保税港区的申报通关、仓储服务：</p>
                                    ...
                                    <div class="tab-pane fade" id="invoice">
                                        ...
                                        <div class="invoice_info">
                                            <p><span>1.Shipment before（装船时间）：</span><fmt:formatDate value="${detail.shipDate}" pattern="yyyy-MM-dd"/></p>
                                            <p><span>2.Payment（付款方式）：</span>${detail.payment }</p>
                                            <p><span>3.Packing（包装）：</span>${detail.pack }</p>
                                            <p><span>4.Port of Loading（装货港）：</span>${detail.portLoading }</p>
                                            <p><span>5.Port of Discharge（卸货港）：</span>${detail.portDest }</p>
                                            <p><span>6.Payment RULES（付款条约）：</span>${detail.payRules }</p>
                                            <p><span>7.Country of Origin（原产国）：</span>${detail.country }</p>
                                            <p><span>8.Shipper（境外发货人）：</span>${detail.shipper }</p>
                                            <p><span>9.Marks and Numbers（唛头）：</span>${detail.mark }</p>
                                        </div>
