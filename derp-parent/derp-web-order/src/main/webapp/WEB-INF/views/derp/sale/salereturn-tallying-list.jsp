                    ...
                    <div class="col-12 row">
                        <div>
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="javascript:$load.a(serverAddr+'/saleReturnTallyin/toPageTransfer.html');">销售退理货单列表</a></li>
                            </ol>
                        </div>
                    </div>
                    <!--  title   end  -->
                        ...
                        <div class="form_box">
                            <div class="form_con">
                                ...
                                <div class="form_item h35">
                                 ...
                                 <div class="form_item h35">
                                    <span class="msg_title">理货时间 :</span>
                    ...
                    <div class="row mt10">
                        <table id="datatable-buttons" class="table table-striped" cellspacing="0" width="100%">
                            ...
                            <tr>
                                ...
                                <th style="white-space:nowrap;" class="tc">销退订单号</th>
...
$module.businessUnit.getSelectBeanByMerchantDepotRel.call($("select[name='buId']")[0],null,null, null,null);
    ...
    $(document).ready(function() {
        ...
        //配置表格参数
        $mytable.params={
            url:serverAddr+'/saleReturnTallyin/listTallyingOrderTransfer.asyn?r='+Math.random(),
            columns:[{ //复选框单元格
                ...
                {data:'code'},{data:'orderCode'},{data:'depotName'},{data:'buName'},{data:'contractNo'},{data:'tallyingDate'},{data:'state'},
                { //操作
                    orderable: false,
                    width: "80px",
                    data: null,
                    render: function (data, type, row, meta) {
                        return '<shiro:hasPermission name="saleReturnTallyin_detail"><a href="javascript:details(' + row.id + ')">详情</a>&nbsp;&nbsp;</shiro:hasPermission>';
                    }
                },
            ],
            formid:'#form1'
    ...
    //详情
    function details(id){
        $module.load.pageOrder("act=50041&id="+id);
    }
    ...
    function tallyConfirm(state){
        ...
        $custom.alert.warning("确定提交选中对象？",function(){
            var url=serverAddr+"/saleReturnTallyin/tallyConfirmTransfer.asyn";
