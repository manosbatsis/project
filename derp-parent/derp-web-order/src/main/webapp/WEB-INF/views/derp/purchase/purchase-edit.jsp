                ...
                <div>
                   <div class="col-12 row">
                    <div>
                       ...
                       <li class="breadcrumb-item"><a href="javascript:dh_edit(${detail.id });">编辑采购订单</a></li>
                    </ol>
                    </div>
                   </div>
                    <!--  title   end  -->               
                ...
                <form id="add-form">
                    <div class="edit_box mt20">
                        <div class="edit_item">
                            ...
                            <c:choose>
                                <c:when test="${detail.status eq '001' }">
                                    <select class="edit_input" name="buId" id="buId" submitReqired required reqMsg = "事业部不能为空">
                                        <option value="">请选择</option>
                                    </select>
                                </c:when>
                                <c:otherwise>
                                    <input type="hidden" name="buId" id="buId" value="${detail.buId }">
                                    <input parsley-type="text" class="edit_input" type="text" name="buName" id="buName" value="${detail.buName }" readonly>
                                </c:otherwise>
                            </c:choose>
                    ...
                    <div class="edit_box">
                        ...
                        <div class="edit_item">
                            ...
                            <input type="text"  parsley-type="text" class="edit_input" name="poNo" id="poNo" value="${detail.poNo }" submitReqired required reqMsg = "PO号不能为空">
                        	<input type="hidden"  parsley-type="text" class="edit_input" id="poNo_first" value="${detail.poNo }">
                        </div>
                    </div>
                    <div class="edit_box">
                    	<div class="edit_item">
                        ...
                        <div class="edit_item">
                        	...
                        	<input type="text" class="edit_input" name="attributionDate" id="attributionDate" submitReqired required reqMsg = "归属日期不能为空" style="font-size:13px;" value="<fmt:formatDate value="${detail.attributionDate }" pattern="yyyy-MM-dd"/>">
                        </div>
                        <div class="edit_item">
                            ...
                            <input type="hidden"  parsley-type="text" class="edit_input" name="oldLbxNo" value="${detail.lbxNo }">
                        </div>
                    </div>
                    <div class="edit_box">
                    	<div class="edit_item" >
                        ...
                        <div class="edit_item"  id="tallyingUnitDiv">
                        	<c:if test="${depotType eq 'c' }">
	                            ...
	                            <select name="tallyingUnit" class="edit_input" id="tallyingUnit" required reqMsg = "海外仓理货单位不能为空">
	                            	<option value="">请选择</option>
                    ...
                    <div class="edit_box mt20">
                    	<div class="edit_item">
                        	...
                        	<select name="transport" id="transport" class="edit_input" required reqMsg = "运输方式不能为空">
                            	<option value="">请选择</option>
                            </select>
                        </div>
                        <div class="edit_item">
                         	...
                         	<input type="text" parsley-type="text" class="edit_input" name="standardCaseTeu" id="standardCaseTeu" value="${detail.standardCaseTeu }" <c:if test="${ detail.transport eq '2'}">required reqMsg = "标准箱TEU不能为空"</c:if> >
                        </div>
                        <div class="edit_item">
                            <c:choose>
                           	...
                           	<input type="text" parsley-type="text" class="edit_input" name="trainNumber" id="trainNumber" value="${detail.trainNumber }" <c:if test="${detail.transport eq '3' || detail.transport eq '4'}">required reqMsg = "车次不能为空"</c:if> >
                        </div>
                    </div>
                    <div class="edit_box">
                    	<div class="edit_item">
                        	...
                        	<input type="hidden"  parsley-type="text" class="edit_input" name="oldContractNo" id="contractNo_first" value="${detail.contractNo }">
                        </div>
                        <div class="edit_item">
                            <label class="edit_label"><i class="red" id="loadPortI">*</i> 装货港：</label>
                            <input type="text" parsley-type="text" class="edit_input" id="loadPort" name="loadPort" value="${detail.loadPort }" required reqMsg = "装货港不能为空">
                        </div>
                        <div class="edit_item">
                        	<label class="edit_label"><i class="red" id="unloadPortI">*</i> 卸货港：</label>
                            <select class="edit_input" name="unloadPort" id="unloadPort" required reqMsg = "卸货港不能为空">
                        		<option value="">请选择</option>
                        	</select>
                        </div>
                    </div>
                    <div class="edit_box">
                    	<div class="edit_item">
                            ...
                            <input type="text"  parsley-type="text" class="edit_input" name="carrier" id="carrier" value="${detail.carrier }" required reqMsg = "承运商不能为空">
                        </div>
                        <div class="edit_item">
                        	<c:choose>
                           	...
                           	<input type="text" parsley-type="text" class="edit_input" name="ladingBill" id="ladingBill" value="${detail.ladingBill }" <c:if test="${detail.transport eq '1' || detail.transport eq '2'}">required reqMsg = "提单号不能为空"</c:if>>
                        </div>
                        <div class="edit_item">
                            <label class="edit_label">提单毛重KG：</label>
                            <input type="text"  parsley-type="text" class="edit_input" name="grossWeight" id="grossWeight" value="${detail.grossWeight }" onblur="calcItemGrossWeight();" onkeyup="amountVal(this, '5')">
                        </div>
                    </div>
                    <div class="edit_box">
                        <div class="edit_item">
                        	<label class="edit_label"><i class="red" id="torrNumI">*</i> 托数：</label>
                            <input type="text"  parsley-type="text" class="edit_input" name="torrNum" id="torrNum" value="${detail.torrNum }" required reqMsg = "托数不能为空" onkeyup="amountVal(this, '0')" onblur="setPackType() ">
                        </div>
                        <div class="edit_item">
                        ...
                        <div class="edit_item">
                            ...
                            <input type="text"  parsley-type="text" class="edit_input form_datetime date-input" name="arriveDate2" id="arriveDate2"  value="${arriveDate }">
                        </div>
                    </div>
                    <div class="edit_box">
                    	<div class="edit_item">
                    ...
                    <div class="edit_box">
                        <div class="edit_item">
                            ...
                            <input type="text"  parsley-type="text" class="edit_input form_datetime date-input" name="arriveDepotDate2" value="${arriveDepotDate }">
                        </div>
                        <div class="edit_item">
                            <label class="edit_label">预计付款时间：</label>
                            <input type="text"  parsley-type="text" class="edit_input form_datetime date-input" name="paymentDate2" value="${paymentDate }">
                        </div>
                        <div class="edit_item">
                            <label class="edit_label">装船时间：</label>
                            <input type="text"  parsley-type="text" class="edit_input form_datetime date-input" name="shipDate2" value="${shipDate }">
                        </div>
                    </div>
                    <div class="edit_box">
                    	<div class="edit_item">
                            <label class="edit_label">收货地点：</label>
                            <input type="text"  parsley-type="text" class="edit_input" name="deliveryAddr" value="${detail.deliveryAddr }">
                        </div>
                        <div class="edit_item">
                 ...
                 <!--   款项信息  end -->
                   <!--   商品信息  start -->
                    <div class="col-12 ml10">
                        ...
                        <div class="col-1 mt10">
                            <button type="button" class="btn btn-find waves-effect waves-light btn_default" id="chooseGoods-button" onclick="chooseGoods();">选择商品</button>
                        </div>
                         <div class="col-1 mt10">
                   ...
                   <table id="table-list" class="table table-striped " style="width: 1300px">
                       <thead>
                       <tr>
...
<script type="text/javascript">
	...
	$(function(){
		...
		$module.depot.getSelectBeanByDepotCustomsRel.call($("select[name='inCustomsId']")[0],"${detail.depotId}",'${detail.inCustomsId }');
		...
		**/
		...
		$("#depotId").change(function(){
			...
			$custom.request.ajax("/depot/getDepotDetails.asyn", {"id":depot_id}, function(result){
				...
				if(result.data.type == 'c'){
					$("#tallyingUnitDiv").html('<label class="edit_label"><i class="red">*</i> 海外仓理货单位：</label><select name="tallyingUnit" id="tallyingUnit" class="edit_input" required reqMsg = "海外仓理货单位不能为空"><option value="">请选择</option><option value="00">托盘</option><option value="01">箱</option><option value="02">件</option></select>');
				}else{
			...
			$custom.request.ajaxSync(serverAddr + "/purchase/getDepotInfo.asyn", {"depotId":depot_id}, function(result){
				if(result.data == "1"){
					$("#address").html('<label class="edit_label"><i class="red">*</i> 目的地名称：</label>'+
							'	<select class="edit_input" name="destinationName" id="destinationName" required reqMsg = "目的地名称不能为空">'+
							'		<option value="">请选择</option>'+
							'	</select>');
					$module.depotSchedule.loadSelectByDepotId.call($("select[name='destinationName']")[0], depot_id, "${detail.destinationName }");
				} else {
					$("#address").html('<label class="edit_label">目的地名称：</label>'+
		...
		$("#save-buttons").click(function(){
            ...
            $custom.alert.warning("确定提交该采购订单？",function(){
                //区分提交状态和审核状态必填项校验
            	if('001' == orderStatus &&
            			!sumbitVerificationRequired()){
            		return ;
            	}else if('002' == orderStatus &&
            			!$checker.verificationRequired()){
            		return ;
            	}
                ...
                if(is_overseas == 1){
                    if($("#tallyingUnit").val()==""){
                        $custom.alert.error("仓库为海外仓时，海外仓理货单位必填！");
                        return ;
                    }
                }
                ...
                if('002' == orderStatus && grossWeight_flag==1){
                ...
                if('002' == orderStatus && netWeight_flag==1){
                ...
                var contractNo_first = $("#contractNo_first").val();
                var poNo = $("#poNo").val();
                var poNo_first = $("#poNo_first").val();
                if(contractNo == contractNo_first){
                    contractNo = "";
                }
                if(poNo == poNo_first){
                    poNo = "";
		...
		function saveData(billWeight){
			var url = serverAddr+"/purchase/modifyPurchaseOrder.asyn";
			...
			$custom.request.ajax(url, form, function(result){
				if(result.state == '200'){
					$custom.alert.success("编辑成功，请编辑合同");
					setTimeout(function () {
	...
	/**限制输入框不能超过5位小数*/
  	...
  	function depotTypeGLogic(depotType){
  		if(depotType== 'd'
			...
			$("#carrier").removeAttr("reqMsg") ;
			$("#torrNum").removeAttr("required") ;
			$("#torrNum").removeAttr("reqMsg") ;
			$("#transport").removeAttr("required") ;
			$("#transport").removeAttr("reqMsg") ;
			$("#loadPort").removeAttr("required") ;
			$("#loadPort").removeAttr("reqMsg") ;
			$("#unloadPort").removeAttr("required") ;
			$("#unloadPort").removeAttr("reqMsg") ;
		}else{
			$("#transportI").show() ;
			$("#torrNumI").show() ;
			$("#loadPortI").show() ;
			...
			$("#carrier").attr("reqMsg", "承运商不能为空") ;
			$("#torrNum").attr("required", "required") ;
			$("#torrNum").attr("reqMsg", "托数不能为空") ;
			$("#transport").attr("required", "required") ;
			$("#transport").attr("reqMsg", "运输方式不能为空") ;
			$("#loadPort").attr("required", "required") ;
			$("#loadPort").attr("reqMsg", "装货港不能为空") ;
			$("#unloadPort").attr("required", "required") ;
			$("#unloadPort").attr("reqMsg", "卸货港不能为空") ;
		}
  	}
	...
	//提交状态下，商品货号、采购数量、采购售单价、采购金额不予修改
	function submitStatusInit(){
		if(orderStatus == '001'){
			return ;
		}
		
		// 去掉新增删除商品按钮
		$("#chooseGoods-button").remove() ;
		$("#delete-list-button").remove() ;
		
		$("#itemTbody").find(".goods-price").prop("readonly", "readonly") ;
		$("#itemTbody").find(".goods-amount").prop("readonly", "readonly") ;
		$("#itemTbody").find(".goods-num").prop("readonly", "readonly") ;
		$("#itemTbody").find(".taxAmount").prop("readonly", "readonly") ;
	}
