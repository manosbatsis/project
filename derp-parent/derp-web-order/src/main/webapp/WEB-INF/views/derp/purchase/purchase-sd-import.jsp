            ...
            <div class="col-12">
                ...
                <div class="col-12 row">
                    <div>
                       ...
                       <li class="breadcrumb-item"><a href="javascript:dh_import();">调整SD导入</a></li>
                    </ol>
                    </div>
            </div>
                    <!--  title   end  -->
...
<script type="text/javascript">
	$(function(){
		...
		$("#form-upload").on("change",'.file-import',function(){
			...
			if(suffix=="xlsx" || suffix=="xls"){
				...
				$custom.request.ajaxUpload(serverAddr+"/purchaseSdOrder/importOrder.asyn", formData, function(result){
					$(".popupbg").hide();
					if(result.state == '200'){
	...
	$("#downloadTemplate").click(function(){
		$downLoad.downLoadByUrl("/excelTemplate/download.asyn?ids=150");
	})
</script>