                ...
                <div>
                   <div class="col-12 row">
                    <div>
                       ...
                       <li class="breadcrumb-item"><a href="#">编辑采购退货订单</a></li>
                    </ol>
                    </div>
                   </div>
                    <!--  title   end  -->               
                    ...
                    <div class="edit_box mt20">
                        ...
                        <div class="edit_item">
                            ...
                            <input type="text" class="edit_input" value="${detail.merchantName}" name = "merchantName" id = "merchantName" readonly>
                        </div> 
                        <div class="edit_item">
                    ...
                    <div class="edit_box">
                        <div class="edit_item">
                             ...
                             <input type="text" required reqMsg = "PO单号不能为空" parsley-type="text" class="edit_input" id="poNo" name="poNo" value="${detail.poNo }">
                         </div>
                         <div class="edit_item">
                    ...
                    <div class="edit_box">
                        ...
                        <div class="edit_box mt20">
                        	<div class="edit_item" >
		                     ...
		                     <div class="edit_item">
	                            ...
	                            <input type="text" parsley-type="text" class="edit_input" id="deliveryName" name="deliveryName" value="${detail.deliveryName}" required reqMsg = "收货人名称不能为空">
	                        </div>
	                        <div class="edit_item">
	                        </div>
                        </div>
                        <div class="edit_box">
		                     <div class="edit_item">
	                            ...
	                            <input type="text" parsley-type="text" class="edit_input" id="country" name="country" value="${detail.country}" required reqMsg = "国家不能为空">
	                        </div>
	                        <div class="edit_item">
	                            <label class="edit_label"><i class="red depot_type_c">*</i> 详细地址：</label>
	                            <input type="text"  parsley-type="text" class="edit_input" id="deliveryAddr" name="deliveryAddr" value="${detail.deliveryAddr}" required reqMsg = "详细地址不能为空">
	                        </div>
	                        <div class="edit_item">
	                        </div>
                        </div>
                                    ...
                                    <table id="datatable-buttons" class="table table-striped" cellspacing="0"
                                        ...
                                        <c:forEach items="${itemList}"  var="item">
                                         <tr>
                                          ...
                                          <td>
                                          		<input type="text" class="form-control" name="returnNum" onkeyup="value=value.replace(/[^\d]/g,'')" value="${item.returnNum }">
                                          	</td>
                                            <td>
                                            	<input type="text" class="form-control" name="returnPrice" onkeyup="value=value.replace(/[^\d^\.]/g,'')"  value="<fmt:formatNumber value="${item.returnPrice }" pattern="#.##" minFractionDigits="8" > </fmt:formatNumber>">
                                           	</td>
                                           	<td>
                                           		<input type="text" class="form-control" name="declarePrice" onkeyup="value=value.replace(/[^\d^\.]/g,'')"  value="<fmt:formatNumber value="${item.declarePrice }" pattern="#.##" minFractionDigits="5" > </fmt:formatNumber>">
                                           	</td>
                                           <td>
                                           		<input type="text" class="form-control" name="returnAmount" onkeyup="value=value.replace(/[^\d^\.]/g,'')" value="${item.returnAmount }">
                                            </td>
                                             <td>
                                             	<input type="text" class="form-control" name="brandName" value="${item.brandName}"/>
                                            </td>
                                            <td>
                                              	<input type="text" class="form-control" name="boxNo" value="${item.boxNo}">
                                              </td>
                                              <td>
                                              	<input type="text" class="form-control" name="contractNo" value="${item.contractNo}">
                                              	</td>                     
                                              <td>
...
<script type="text/javascript">
 ...
 $(document).ready(function() {
   ...
   //根据入库库仓库加载
	...
	// 是否同关区
	$module.constant.getConstantListByNameURL.call($('select[name="isSameArea"]')[0],"isSameAreaList",'${detail.isSameArea}');
	//加载销售币种的下拉数据
	...
	$module.constant.getConstantListByNameURL.call($('select[name="destinationName"]')[0],"purchaseReturnOrder_destinationList",'${detail.destinationName}');
	
	$module.constant.getConstantListByNameURL.call($('select[name="deliveryMethod"]')[0],"purchaseReturnOrder_mailModeList", '${detail.deliveryMethod}');
	...
	$("#save-buttons").click(function(){
			...
			$custom.request.ajax(url, form, function(data){
				if(data.state==200){
					...
					//重新加载页面
					setTimeout("$module.load.pageOrder('act=3008');", 1000);
				}else{
					if(!!data.expMessage){
