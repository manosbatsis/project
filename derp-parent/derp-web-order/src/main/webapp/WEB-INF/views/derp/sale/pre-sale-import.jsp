            ...
            <div class="col-12">
                ...
                <div class="col-12 row">
                    <div>
                       ...
                       <li class="breadcrumb-item "><a href="javascript:$module.load.pageOrder('act=6001');">预售单列表</a></li>
...
$("#form-upload").on("change",'.file-import',function(){
	...
	if(suffix=="xlsx" || suffix=="xls"){
		...
		$custom.request.ajaxUpload(serverAddr+"/preSale/importPreSale.asyn?r=1", formData, function(result){
			if(result.state == '200'){
...
// 	this.location.href="/excelTemplate/download.asyn?ids=114";
// }

	// 模板下载
	$("#downloadTemplate").click(function(){
		$downLoad.downLoadByUrl("/excelTemplate/download.asyn?ids=138");
	})
</script>