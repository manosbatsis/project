                                ...
                                <div style="overflow-x: auto;">
                                    ...
                                    <table class="pure-table pure-table-bordered">
                                        <tr style="text-align:center;font-weight: bolder;">
                                            ...
                                            <td colspan="8" style="font-size: 14px;text-align: left;">
                                        ...
                                        <tr>
                                            <td colspan="9" style="font-size: 36px; text-align: center;">COMMERCIAL INVOICE</td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="8" style="text-align: left;">INVOICE DATE :
                                        ...
                                        <tr>
                                            <td></td>
                                            <td colspan="8" style="text-align: left;">INVOICE NUMBER:</td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td colspan="9" style="font-size: 20px;text-decoration:underline; text-align: left; padding-top: 20px;">INVOICE PARTICULARS</td>
                                        </tr>
                                            ...
                                            <c:choose>
                                                ...
                                                <c:otherwise>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>${currency }</td>
                                                        <input type="hidden" name="goods.currency" value="${currency}">
                                                        <td><input class="totalPrice_input" type="text" name="goods.totalPrice" value="${item.totalPrice}" onchange="isNumber(this)"></td>
                                                    </tr>
                                                    </tr>
                                                </c:otherwise>
                                            </c:choose>
                                        ...
                                        <tr>
                                            <td colspan="9" style="text-align:left;font-weight:bold;font-size: 14px; text-decoration:underline;" >Notes</td>
                                        </tr>
                                        <tr>
                                            <td colspan="9" style="text-align: left;font-size: 12px;">(1) Order will only be confirmed once the buyer has settled full payment</td>
                                        </tr>
                                        <tr>
                                            <td colspan="9" style="text-align: left;font-size: 12px;padding-bottom: 20px;">(2) Any bank charges or extra expenses incurred on behalf of the Buyer shall be borne by the Buyer.</td>
                                        </tr>
                                        <tr>
                                            <td colspan="9" style="text-align:left;font-weight:bold;font-size: 14px; " >For and on behalf of:</td>
                                        </tr>
                                        <tr>
                                            <td colspan="9" style="text-align:left;font-weight:bold;font-size: 14px; padding-bottom: 20px;" >(Seller) Supplier A Co. Ltd
                                                <span>(${merchantInfo.englishName})</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="9" style="text-align:left;font-weight:bold;font-size: 16px; " >BANK DETAILS</td>
                                        </tr>
                                        <tr>
                                            <td colspan="9" style="text-align:left;font-size: 16px; " >BANK NAME：<span>${merchantInfo.depositBank }</span></td>
                                            <input type="hidden" name="detail.depositBank" value="${merchantInfo.depositBank}">
                                        </tr>
                                        <tr>
                                            <td colspan="9" style="text-align:left;font-size: 16px; " ><span>${merchantInfo.bankAddress }</span></td>
                                            <input type="hidden" name="detail.bankAddress" value="${merchantInfo.bankAddress}">
                                        </tr>
                                        <tr>
                                            <td colspan="9" style="text-align:left;font-size: 16px; " >ACCOUNT NO.<span>${merchantInfo.bankAccount }</span></td>
                                            <input type="hidden" name="detail.bankAccount" value="${merchantInfo.bankAccount}">
                                        </tr>
                                        <tr>
                                            <td colspan="9" style="text-align:left;font-size: 16px; padding-bottom: 20px;" >SWIFT CODE<span> ${merchantInfo.swiftCode }</span></td>
                                            <input type="hidden" name="detail.swiftCode" value="${merchantInfo.swiftCode}">
                                        </tr>
                                        <tr>
                                            <td colspan="9" style="text-align: left;font-size: 12px;border-top: 1px solid #000000;">Authorized Signature, company chop & date</td>
                                        </tr>
                                    </table>
...
<script type="text/javascript">
    ...
    function sumPrice(obj) {
        ...
        var extraAmount = formatNum($(trObj).find("td").eq(6).find("input").val());
        var preTotalPrice = formatNum($(trObj).find("td").eq(8).find("input").val());
        var totalPrice = (exactPrice*num).add(parseNum(customerReturn)).add(parseNum(promotionDiscountsCust)).add(parseNum(promotionDiscounts)).add(parseNum(extraAmount));
        $(trObj).find("td").eq(8).find("input").val(formatQ(totalPrice));
        ...
        //品牌合计的合计总额修改
        var preTotalVal = $(tempObj).find("td").eq(8).find("input").val();
        var totalVal = parseNum(diffVal).add(formatNum(preTotalVal));
        $(tempObj).find("td").eq(8).find("input").val(formatQ(totalVal));
