            ...
            <div class="col-12">
                ...
                <div class="col-12 row">
                    <div>
                       ...
                       <li class="breadcrumb-item "><a href="javascript:$module.load.pageOrder('act=4001');">销售订单</a></li>
...
$("#form-upload").on("change",'.file-import',function(){
	...
	if(suffix=="xlsx" || suffix=="xls"){
		...
		$custom.request.ajaxUpload(serverAddr+"/sale/importSale.asyn?r=1", formData, function(result){
			$(".popupbg").hide();
			if(result.state == '200'){
...
// }
	...
	$("#downloadTemplate").click(function(){
		$downLoad.downLoadByUrl("/excelTemplate/download.asyn?ids=114");
	})
</script>