            ...
            <div class="col-12">
                ...
                <div class="col-12 row">
                    <div>
                       ...
                       <li class="breadcrumb-item "><a href="javascript:$module.load.pageOrder('act=4011');">账单出库单</a></li>
...
<script type="text/javascript">
	...
	$("#form-upload").on("change",'.file-import',function(){
		...
		if(suffix=="xlsx" || suffix=="xls"){
			...
			$custom.request.ajaxUpload(serverAddr+"/billOutinDepot/importBillOutinDepot.asyn", formData, function(result){
				
				$(".popupbg").hide();
				
				if(result.state == '200' && result.data["success"] > 0){
	...
	$("#downloadTemplate").click(function(){
		$downLoad.downLoadByUrl("/excelTemplate/download.asyn?ids=132");
	})
</script>