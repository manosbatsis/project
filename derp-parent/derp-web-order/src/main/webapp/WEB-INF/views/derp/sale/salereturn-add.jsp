                ...
                <div>
                   <div class="col-12 row">
                    <div>
                       ...
                       <li class="breadcrumb-item"><a href="#">新增销售退货订单</a></li>
                    </ol>
                    </div>
                   </div>
                    <!--  title   end  -->               
                    ...
                    <div class="edit_box mt20">
                   		...
                   		<input type="hidden" value="${businessModel}" name="businessModel" id="businessModel"/>
                        <input type="hidden" class="form-control" name="saleOrderRelCode" id="saleOrderRelCode" value="${detail.saleOrderRelCode}">
                        <div class="edit_item">
                            <label class="edit_label"><i class="red">*</i> 公   司：</label>
                            <input type="hidden" value="${merchantId}" name="merchantId" id="merchantId"/>
                            <input type="text" class="edit_input" value="${merchantName}" name = "merchantName" id = "merchantName" disabled>
                        </div> 
                        	...
                        	<div class="edit_item">
	                            <label class="edit_label"><i class="red">*</i> 退货类型：</label>
		                            <select class="edit_input" name="returnType" id="returnType">
		                                ...
		                                <option value="1" >消费者退货</option>
		                                <option value="2" disabled="disabled">代销退货</option>
                    ...
                    <div class="edit_box">
                    	...
                    	<div class="edit_item">
                            ...
                            <input type="text" class="edit_input" name="fContractNo" id="contractNo" >
                        </div>
                        <div class="edit_item">
                             <label class="edit_label"><i class="red" style="display:none;" id="ladingBill_i">*</i> 头程提单号：</label>
                             <input type="text" required="" parsley-type="text" class="edit_input" id="ladingBill" name="ladingBill" maxlength="50">
                         </div>
                    </div>
                     <div class="edit_box">
                         <div class="edit_item">
                             <label class="edit_label"><i class="red" style="display:none;" id="deliveryAddr_i">*</i> 收货地址：</label>
                             <input type="text" parsley-type="text"  class="edit_input" id="deliveryAddr" maxlength="200">
                         </div>
                         <div class="edit_item">
                              ...
                              <input type="text" required="" parsley-type="text" class="edit_input"
                                     id="boxNum" maxlength="20" onkeyup="value=value.replace(/[^\d]/g,'')">
                          </div>
                          <div class="edit_item">
                            <label class="edit_label"><i class="red" style="display:none;"id="portLoading_i">*</i>装货港：</label>
                            <input type="text" required="" parsley-type="text" class="edit_input" name="portLoading" id="portLoading">
                          </div>                  
                    </div>
                    <div class="edit_box">                    
	                  <!-- <div class="edit_item">
	                        ...
	                        <div class="edit_item">
	                            ...
	                            <input type="text" required="" parsley-type="text" class="edit_input" name="payRules" id="payRules">
                       		 </div>
                       		 <div class="edit_item">
	                            <label class="edit_label"><i class="red"style="display:none;" id="billWeight_i">*</i>提单毛重KG：</label>
	                            <input type="text" required="" disabled parsley-type="text" value="${detail.billWeight}" class="edit_input" name="billWeight" id="billWeight">
                        	</div>         
                    </div>
                    <div class="edit_box">
                    		 <div class="edit_item">
	                            ...
	                            <input type="text" required="" parsley-type="text" class="edit_input" name="shipper" id="shipper">
                        	</div>
	                    	 <div class="edit_item">
                            <label class="edit_label"><i class="red" style="display:none;"id="mark_i">*</i>唛头：</label>
                            <input type="text" required="" parsley-type="text" class="edit_input" name="mark" id="mark">
                        	</div>
                    </div> 
                     	<div class="edit_box">
                    	 	 <div class="edit_item">
	                            <label class="edit_label">LBX单号：</label>
	                            <input type="text" required="" parsley-type="text" class="edit_input" name="lbxNo" id="lbxNo">
                        	</div>
                          <div class="edit_item">
                        ...
                        <div class="edit_item">
	                            ...
	                            <input type="text" required="" parsley-type="text" class="edit_input" name="remark" id="remark">
                        </div> 
                     	</div>
                     <div class="edit_box">
                     		<div class="edit_item">
	                     ...
	                     <div class="edit_item">
                             ...
                             <input type="text" parsley-type="text" class="edit_input" id="invoiceNo" maxlength="50">
                         </div>
                        </div>
                   </div>  	
                 <!--  title   基本信息  start -->
                     <!--   商品信息  start -->
                                ...
                                <div class="row col-12 mt20 table-responsive">
                                    <table id="datatable-buttons" class="table table-striped" cellspacing="0"
                                        ...
                                        <tbody>
                                        <c:forEach items="${detail.itemList}"  var="item" varStatus="indexStatus">
                                         <tr>
                                            <!-- <td>1</td> -->
                                            <td class="tc nowrap"><i class="fi-plus" onclick="addtr();"></i>&nbsp;&nbsp;&nbsp;<i
                                                    class="fi-minus" onclick="deltr(this);"></i></td>
                                             <%-- 	<input type='hidden' name='id' value='${item.id}'> --%>
	                    						<input type='hidden' name='goodsId' value='${item.inGoodsId}'></td>

                                            <td><input type="text" style="width: 80px;" class="form-control" name="seq" value="${indexStatus.index + 1}"/></td>
                                          ...
                                          <td><input type="text" class="form-control" name="totalNum" onkeyup="value=value.replace(/[^\d]/g,'')" readonly="readonly"  maxlength="9"></td>
                                           <td><input type="text" class="form-control" name="returnNum"
                                                     onchange="setTotalNum(this);"  onkeyup="value=value.replace(/[^\d]/g,'')" maxlength="9" value="0">
                                            </td>
                                      ...
                                      <tr>
                                          ...
                                          <td><input type="text" class="form-control" name="totalNum" onkeyup="value=value.replace(/[^\d]/g,'')" readonly="readonly"  maxlength="9"></td>
                                           <td><input type="text" class="form-control" name="returnNum" onchange="setTotalNum(this);"  onkeyup="value=value.replace(/[^\d]/g,'')" maxlength="9" value="0">
                                            </td>
                                            <td><input type="text" class="form-control" name="badGoodsNum"
                                                      onchange="setTotalNum(this);" onkeyup="value=value.replace(/[^\d]/g,'')" maxlength="9" value="0">
                                            </td>
...
var outDepotIsTopBooks=null;//出仓仓库是否代销仓
 $(document).ready(function() {
	 ...
	 var businessModelVal ="${detail.outDepotId}" ;
	 //重新加载事业部
     $module.businessUnit.getSelectBeanByMerchantDepotRel.call($("select[name='buId']")[0],null,null, "${detail.outDepotId}",null);
	 //暂存仓且标识为代销仓
      ...
      */
	 if(businessModel=="2"){ //代销
        //加载退入仓库的下拉数据
        $module.depot.getSelectBeanByMerchantRel.call($('select[name="inDepotId"]')[0],null,{"type":"a,c,f"});
        //加载退出仓库的下拉数据
	 ...
	 } else if (businessModel=='1') { //购销-整批结算
        //加载退入仓库的下拉数据
        $module.depot.getSelectBeanByMerchantRel.call($('select[name="inDepotId"]')[0],'${detail.outDepotId}',{"type":"a,c,d,f"});
        //加载退出仓库的下拉数据
        $module.depot.getSelectBeanByMerchantRel.call($('select[name="outDepotId"]')[0],null,{"type":"b,e"});
        if (depotE) {
            depotE.forEach(function(o,i){
                $("#outDepotId option[value='" + o.value + "']").remove();
            });
        }
	 } else if (businessModel=='4') { //购销-实销实结
         //加载退入仓库的下拉数据
         $module.depot.getSelectBeanByMerchantRel.call($('select[name="inDepotId"]')[0],'${detail.outDepotId}',{"type":"a,c,d,f"});
         //加载退出仓库的下拉数据
         $module.depot.getSelectBeanByMerchantRel.call($('select[name="outDepotId"]')[0],'${detail.inDepotId}',{"type":"b,e"});
         if (depotE) {
             depotE.forEach(function(o,i){
                 $("#outDepotId option[value='" + o.value + "']").remove();
             });
	...
	// 卸货港
	$module.constant.getConstantListByNameURL.call($('select[name="portDestNo"]')[0],"portDestList",null);
	//加载客户的下拉数据
    ...
    $("#customerId").change(function(){
	 ...
	 if(isForbid=="no"){
		 ...
		 var returnType = $("#returnType").val();
		  var customerVal ="${detail.customerId}" ;
	        if(customerVal){
	            $module.currency.loadSelectData.call($("select[name='currency']")[0],customerVal);
	        }
    ...
    $(function(){
		...
		$("#save-buttons").click(function(){
			var url = serverAddr+"/saleReturn/saveSaleReturnOrder.asyn";
			var form = {
			};
			var json = {};
	...
	//同关区选择
	 $("#isSameArea").change(function() {
         ...
         getMustParameter(1,isSameArea,outId,inId,returnType);
	 });
    ...
    $("#outDepotId").change(function() {
    	...
    	getMustParameter(2,isSameArea,outId,inId,returnType);
    	//重新加载事业部
 ...
 function getMustParameter(checkFlag,isSameArea,outId,inId,returnType){
		//检查是否涉及香港仓，是则添加理货单位
		if(inId){	// 退入仓库
			$custom.request.ajaxSync("/depot/checkDepotMerchantRel.asyn", {"depotId":inId}, function(result1){
				...
				if((returnType=='3' && inDepotTypeVal=='a' && inIsInOutInstructionVal =='1') ||
                    ...
                    (returnType=='2' && inDepotTypeVal== 'c')){		// 购销退货、代销退货类型，且退入仓为卓志海外仓时必填，其他情况下非必填
					// 海外理货单位 显示
