            ...
            <div class="col-12">
                ...
                <div class="col-12 row">
                    <div>
                       ...
                       <li class="breadcrumb-item"><a href="javascript:dh_list();">采购退货出库订单列表</a></li>
...
<script type="text/javascript">
	$(function(){
		...
		$("#form-upload").on("change",'.file-import',function(){
			...
			if(suffix=="xlsx" || suffix=="xls"){
				...
				$custom.request.ajaxUpload(serverAddr+"/purchaseReturnOdepot/importOrder.asyn", formData, function(result){
					$(".popupbg").hide();
					if(result.state == '200'){
	...
	function dh_import(){
		$module.load.pageOrder("act=30091");
	}
	
	// 模板下载
	$("#downloadTemplate").click(function(){
		$downLoad.downLoadByUrl("/excelTemplate/download.asyn?ids=133");
	})
</script>