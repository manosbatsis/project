            ...
            <div class="col-12">
                ...
                <div class="col-12 row">
                    <div>
                       ...
                       <li class="breadcrumb-item"><a href="#">平台数据</a></li>
                       <li class="breadcrumb-item"><a href="javascript:$module.load.pageOrder('act=210001');">平台商品管理</a></li>
                       <li class="breadcrumb-item"><a href="javascript:$module.load.pageOrder('act=210002');">平台商品导入</a></li>
                    </ol>
                    </div>
            </div>
                    <!--  title   end  -->
...
<script type="text/javascript">
	$(function(){
		...
		$("#form-upload").on("change",'.file-import',function(){
            ...
            var uploadUrl = serverAddr+"/platformMerchandise/platformMerchandiseImport.asyn";
    ...
    $("#downloadTemplate").click(function(){
        $downLoad.downLoadByUrl("/excelTemplate/download.asyn?ids=146");
    })
</script>