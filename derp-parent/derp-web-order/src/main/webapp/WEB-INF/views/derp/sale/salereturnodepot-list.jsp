				...
				<div class="card-box">
					<div class="col-12 row">
						<div>
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><a href="#">销售退货出库单</a></li>
							</ol>
						</div>
					</div>
					<!--  title   end  -->
						...
						<div class="form_box">
							...
							<%--	<div class="form-row h35">
								...
								<div class="form_item h35">
									<span class="msg_title">销退出库单号 :</span>
								...
								<div class="form_item h35">
									<span class="msg_title">退货出库时间 :</span>
					...
					<div class="row col-12 mt20">
						<div class="button-list">
							<shiro:hasPermission name="saleReturnOdepot_exportSaleReturnOdepot">
					...
					<div class="mt10 table-responsive">
						<table id="datatable-buttons" class="table table-striped" cellspacing="0" width="100%">
							...
							<tr>
								...
								<th style="white-space: nowrap;" class="tc">销退出库单号</th>
								...
								<th style="white-space: nowrap;" class="tc">退货出库时间</th>
...
$module.constant.getConstantListByNameURL.call($('select[name="status"]')[0],"saleReturnOdepot_statusList",null);
//加载事业部
$module.businessUnit.getSelectBeanByMerchantDepotRel.call($("select[name='buId']")[0],null,null, null,null);
    ...
    $(document).ready(
        function() {
            ...
            //配置表格参数
            $mytable.params = {
                url : serverAddr+'/saleReturnOdepot/listSaleReturnOdepot.asyn?r=' + Math.random(),
                columns : [
                    { //复选框单元格
                    ...
                    {data : 'code'},{data : 'contractNo'},{data : 'inDepotName'},{data : 'outDepotName'},{data : 'buName'},{data : 'orderCode'},{data : 'statusLabel'},{data : 'returnOutDate'},
                    { //操作
                        orderable : false,
                        data : null,
                        render : function(data, type, row, meta) {
                            return'<shiro:hasPermission name="saleReturnOdepot_detail"><a href="javascript:details(' + row.id + ')">详情</a></shiro:hasPermission>';
                        }
                    }, ],
                formid : '#form1'
            };
    ...
    //详情
    function details(id) {
        $module.load.pageOrder("act=50031&id=" + id);
    }
    /**
     * 全选
     */
    ...
    $("#exportOrder").on("click",function(){
        ...
        $custom.request.ajax(serverAddr+"/saleReturnOdepot/getOrderCount.asyn", form, function(data){//判断导出的数量是否超出1W
        	if(data.state==200){
        		...
        		//导出数据
            	var url = serverAddr+"/saleReturnOdepot/exportSaleReturnOdepot.asyn";
        		var i =0;
            	if(!!form){
           		    for(var key in form){
           		    	if(i==0){
