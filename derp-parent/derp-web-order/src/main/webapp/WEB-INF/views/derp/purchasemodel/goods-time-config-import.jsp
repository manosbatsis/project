            ...
            <div class="col-12">
                ...
                <div class="col-12 row">
                    <div>
                       ...
                       <li class="breadcrumb-item"><a href="javascript:dh_list();">宝洁商品货期配置</a></li>
                       <li class="breadcrumb-item"><a href="javascript:dh_import();">批量导入</a></li>
                    </ol>
                    </div>
            </div>
                    <!--  title   end  -->
...
<!--                               <a href="/excelTemplate/download.asyn?ids=122"> 模版下载</a> -->
									<a href="#">模板下载</a>
                           </div>
                        </div>
                    <!--  ================================上传文件部分  end===============================================   -->
	...
	$(function(){
		...
		$("#form-upload").on("change",'.file-import',function(){
			...
			if(suffix=="xlsx" || suffix=="xls"){
				...
				$custom.request.ajaxUpload(serverAddr+"/goodsTimeConfig/importGoodsTimeConfig.asyn", formData, function(result){
					$(".popupbg").hide();
					if(result.state == '200'){
					...
					$.each(result.data["message"],function(i,d){
						var tr = "";
						tr+="<tr><td style='text-align:center;'>"+d.row+"</td><td style='text-align:center;'>"+d.msg+"</td></tr>";
...
$("#downloadTemplate").click(function(){
	$downLoad.downLoadByUrl("/excelTemplate/download.asyn?ids=122");
})
</script>