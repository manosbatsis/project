                            ...
                            <div>
                                ...
                                <div class="edit_box mt20">
                                    <div class="edit_item">
                                        ...
                                        <select id="outDepotId" name="outDepotId" disabled
                                    ...
                                    <div class="edit_item">
                                        ...
                                        <select id="inDepotId" name="inDepotId" class="edit_input" disabled
                                                required reqMsg="调入仓库不能为空！">
                                            <option value="">请选择</option>
                                        </select>
                                    </div>
                                ...
                                <div class="edit_box">
                                    <div class="edit_item">
                                        ...
                                        <input type="text" parsley-type="text" class="edit_input" id="invoiceNo"
                                               maxlength="50" value="${transferOrder.invoiceNo }">
                                    </div>
                                    <div class="edit_item">
                                    ...
                                    <div class="edit_item">
                                        ...
                                        <input type="text" parsley-type="text" class="edit_input" value="${transferOrder.cartons }"
                                               id="cartons" maxlength="20" onkeyup="value=value.replace(/[^\d]/g,'')" onblur="setPackType();">
                                    </div>
                                </div>
                                <div class="edit_box">
                                    <div class="edit_item">
                                    ...
                                    <div class="edit_item">
                                        ...
                                        <input type="text" parsley-type="text" class="edit_input" value="${transferOrder.standardCaseTeu }"
                                               id="standardCaseTeu" >
                                    </div>
                                    <div class="edit_item">
                                        <label class="edit_label"><i class="red" name="trainNumberLabel"></i> 车次：</label>
                                        <input type="text" parsley-type="text" class="edit_input"
                                               id="trainNumber" value="${transferOrder.trainNumber }">
                                    </div>
                                </div>
                                <div class="edit_box">
                                    <div class="edit_item">
                                        ...
                                        <input type="text" parsley-type="text" class="edit_input"
                                               id="carrier" value="${transferOrder.carrier }">
                                    </div>
                                    <div class="edit_item">
                                ...
                                <div class="edit_box">
                                    <div class="edit_item">
                                        ...
                                        <input type="text" parsley-type="text" class="edit_input" id="firstLadingBillNo"
                                               maxlength="50" value="${transferOrder.firstLadingBillNo }">
                                    </div>
                                    <div class="edit_item">
                                        <label class="edit_label"><i class="red">*</i> 收货地址：</label>
                                        <input type="text" parsley-type="text"  class="edit_input" id="receivingAddress" maxlength="200"
                                               required reqMsg="收货地址不能为空！" value="${transferOrder.receivingAddress }">
                                    </div>
                                   <div class="edit_item">
	                                   <div class="edit_item" >
	                                        <label class="edit_label"><i class="red"  name="consigneeUsernameLabel"></i>收货人姓名：</label>
	                                        <input type="text"  class="edit_input" id="consigneeUsername"
                                                   maxlength="90" value="${transferOrder.consigneeUsername }">
	                                    </div>
                                    </div>
                                </div>
                                <div class="edit_box" >
                                    ...
                                    <div class="edit_item" style="display:none;" id="HKDiv2" >
                                     ...
                                     <div class="edit_item" style="display:none;" id="HKDiv1">
                                         <label class="edit_label" style="font-size: 12px"><i class="red">*</i> 海外仓理货单位：</label>
                                         <div class="edit_input">
                                          <select id="tallyingUnit" name="tallyingUnit" class="form-control">
											  <option value="">请选择</option>
                                          </select>
                                         </div>
                                     </div>
                                ...
                                <div class="edit_box">
                                    ...
                                    <div class="edit_item">
                                        ...
                                        <input type="text"  class="edit_input" id="poNo" maxlength="200"  value="${transferOrder.poNo }">
                                    </div>
                                </div>
                                ...
                                <div class="edit_box">
                                    <div class="edit_item">
                                        ...
                                        <input type="text" parsley-type="text" class="edit_input"
                                               id="contractNo" maxlength="50"  value="${transferOrder.contractNo }">
                                    </div>
                                   <div class="edit_item">
                                    ...
                                    <div class="edit_item">
                                        ...
                                        <div class="edit_input">
                                            <input type="text" class="form-control"  onkeyup="amount5Val(this)"
                                                   id="billWeight" name="billWeight"  value="${transferOrder.billWeight }" onblur="calcItemGrossWeight();">
                                        </div>
                                ...
                                <div class="edit_box">
                                    <div class="edit_item">
                                        ...
                                        <input type="text" parsley-type="text" class="edit_input"
                                               id="lbxNo" maxlength="20" value="${transferOrder.lbxNo}">
                                    </div>
                                                ...
                                                <c:forEach items="${orderItem }" var="item">
                                                    <tr>
                                                        ...
                                                        <td><input type="hidden"  name="netWeight-hidden" value="${item.netWeight}">
                                                            <input type="text" class="form-control" name="netWeight" onchange="sumTotal();"
                                            ...
                                            <c:otherwise>
                                                <tr>
                                                    ...
                                                    <td class="tc nowrap"><i class="fi-plus" onclick="addtr();"></i>&nbsp;&nbsp;&nbsp;
                                                        <i class="fi-minus" onclick="deltr(this);"></i></td>
                                                    ...
                                                    <td><input type="text" class="form-control" name="transferNum"
                                                               onchange="setTransferNum(this);" onkeyup="value=value.replace(/[^\d]/g,'')" maxlength="9">
                                                    </td>
                                                    <td>
                                                        <button type="button"
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        if (buId) {
            //加载调出仓
            $module.depot.getSelectBeanByMerchantBuRel.call($("select[name='outDepotId']")[0],outDepotId, {"buId": buId, "type":"a,b,c,e"});
        }

        if (outDepotId) {
            $("#outDepotId").removeAttr("disabled");
            var outDepotData = $module.depot.getDepotById(outDepotId);
            ...
            $module.constant.getConstantListByNameURL.call($('select[name="inUnit"]')[0],"order_tallyingUnitList",null);
            $module.constant.getConstantListByNameURL.call($('select[name="outUnit"]')[0],"order_tallyingUnitList",null);
        }
        if (inDepotId) {
            $("#inDepotId").removeAttr("disabled");
        ...
        $module.constant.getConstantListByNameURL.call($('select[name="destination"]')[0],"transferOrder_destinationList",destination);
        $module.constant.getConstantListByNameURL.call($('select[name="tallyingUnit"]')[0],"order_tallyingUnitList",tallyingUnit);
        getMustParameter();
        setUnit();//设置理货单位
        sumTotal();
        calculateWeight();
        ...
        if (rows > 1) {
            ...
            $(obj).parent("td").parent("tr").replaceWith('<tr>' +
                ...
                '<td>'+
					...
					'</select>'+
	            '</td>'+
	            '<td><input type="text"  class="form-control" name="transferNum" onchange="setTransferNum(this);" onkeyup="value=value.replace(/[^\\d]/g,\'\')" maxlength="9"></td>' +
    ...
    $("#buId").change(function () {
        $("#outDepotId").removeAttr("disabled");
        $module.depot.getSelectBeanByMerchantBuRel.call($("select[name='outDepotId']")[0],outDepotId, {"buId": $("#buId").val(), "type":"a,b,c,e"});
    });
    ...
    $("#outDepotId").change(function() {
        ...
        if(outDepotId){
            var jsonData = $module.depot.getDepotById(outDepotId);
            $("#outdepotAddr").val(jsonData.address);
        }
    ...
    $("#inDepotId").change(function() {
        ...
        if(inDepotId!=''){
            var jsonData = $module.depot.getDepotById(inDepotId);
            $("#receivingAddress").val(jsonData.address);
            $("#consigneeUsername").val(jsonData.adminName);
        ...
        $("#datatable-buttons tbody tr").each(function (index, item) {
            ...
            if (goodsId) {
                ...
                $(this).find("td").eq(19).find("input").val('');//备注
                $(this).find("td").eq(20).find("input").val('');//备注
            }
        });
        calculateWeight();
        setUnit();
    ...
    function getMustParameter(){
        ...
        if(inDepotType == 'b'){
              ...
              $module.depotSchedule.loadSelectByDepotId.call($('select[name="depotScheduleId"]')[0],inDepotId,null);
        }else{
            $("#depotScheduleId").val('');
        ...
        //清空
        var paramStr = "inCustomerIdLabel,contractNoLabel,invoiceNoLabel,packTypeLabel,cartonsLabel," +
                        "firstLadingBillNoLabel,priceLabel,destinationLabel,consigneeUsernameLabel,countryLabel," +
                        "depotScheduleIdLabel,poNoLabel, bargainnoLabel, contNoLabel, portLoadingLabel";
    ...
    function saveAndAudit() {
        $custom.alert.warning("确定保存并审核该调拨订单？",function(){
            ...
            $("#datatable-buttons tbody tr").each(function (index, item) {
                ...
                var grossWeight = $(this).find("td").eq(14).children('input[name="grossWeight-hidden"]').val();//毛重
                var grossWeightSum = $(this).find("td").eq(14).children('input[name="grossWeight"]').val();//总毛重
                var netWeight = $(this).find("td").eq(14).children('input[name="netWeight-hidden"]').val();//净重
                var netWeightSum = $(this).find("td").eq(15).children('input[name="netWeight"]').val();//总净重
                var contNo = $(this).find("td").eq(16).find("input").val();//箱号
                var bargainno = $(this).find("td").eq(17).find("input").val();//合同号
                var outBarcode = $(this).find("td").eq(18).find("input").val();//调出条形码
            ...
            if (isSeqNull) {
                $custom.alert.warning("存在排序序号为空的商品，是否按现有排序提交？", function () {
                    ...
                    json.goodsList = goodsList;
                    var url = serverAddr + "/transfer/saveTransferOrder.asyn?token=" + token;
                    var jsonStr = JSON.stringify(json);
                    $custom.request.ajaxSync(url,{"json":jsonStr},function(result){
                        if (result.state == '200' && result.data.code == '00') {
                            $custom.alert.success("保存成功！");
    ...
    function cancelOrder() {
        ...
        if (pageSource == "1") {
            ...
            $module.load.pageOrder('act=8001&pageSource=2');
        }
    }
