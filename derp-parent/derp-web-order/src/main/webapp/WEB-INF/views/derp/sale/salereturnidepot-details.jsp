...
<div class="content">
    <div class="container-fluid mt80">
                ...
                <div>
                   <div class="col-12 row">
                    <div>
                       ...
                       <li class="breadcrumb-item"><a href="#">销售退货入库单详细</a></li>
                    </ol>
                    </div>
                   </div>
                    <!--  title   end  -->               
        ...
        <%--        <div class="form-row mt20 ml15">
                    <div class="col-4">
                        <div class="row">
                            <label class="col-4 col-form-label " style="white-space:nowrap;"><span class="fr">退运入库单号<span>：</span></span></label>
                ...
                <div class="form-row mt20 ml15">
                    <div class="col-4">
                        <div class="row">
                            ...
                            <div class="col-8 ml10 line">
                            	<c:if test="${detail.status == '012'}">已入仓</c:if>
                            </div>
                        </div>
                    </div>
                    <div class="col-4">
                ...
                <div class="form-row mt20 ml15">
                 ...
                 <!--  title   基本信息  start -->
                   <!--   商品信息  start -->
                    ...
                    <div class="title_text">销售退货入库商品明细</div>
...
//table
 $(document).ready(function() {
		...
		$("#cancel-buttons").click(function(){
			$module.load.pageOrder("act=5002");
		});
