                                ...
                                <div>
                                    ...
                                    <table class="pure-table pure-table-bordered">
                                        <tr style="text-align:center;">
                                            <td colspan="6">
                                                <input type="hidden" name="detail.merInvoiceName" value="${merchantInfo.fullName} ">
                                                <strong>${merchantInfo.fullName}</strong>
                                                <br>
                                                <input type="hidden" name="detail.merEnglishName" value="${merchantInfo.englishName}">
                                                <strong>${merchantInfo.englishName}</strong>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="6"
                                        ...
                                        <tr>
                                            ...
                                            <td style="width:150px;">
                                                <input type="text" id="poNo" name="detail.poNo" value="${invoice.poNo}" >
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                            ...
                                            <td colspan="5">
                                                ${merchantInfo.englishName}<br>${merchantInfo.englishRegisteredAddress}
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="5">
                                                ${customerInfo.name }<br>${customerInfo.companyAddr }
                                                <input type="hidden" name="detail.customerName" value="${customerInfo.name}">
                                                <input type="hidden" name="detail.customerAddr" value="${customerInfo.companyAddr}">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                        ...
                                        <c:forEach items="${itemLists }" var="item">
                                            <c:choose>
                                                ...
                                                <c:otherwise>
                                                    <tr>
                                                        <td>${item.platformSku == null ? item.goodsNo : item.platformSku }</td>
                                                        <input type="hidden" name="goods.goodsNo" value="${item.platformSku == null ? item.goodsNo : item.platformSku }">
                                                        <td>${item.barcode }</td>
                                        ...
                                        <tr>
                                            <td colspan="6">${merchantInfo.englishName}</td>
                                        </tr>
                                        <tr>
                                            <td colspan="6">(${merchantInfo.englishRegisteredAddress})
