...
<script type="text/javascript">
    ...
    function loadReceiveCostDetail(billId) {
        ...
        var _table = $table.dataTable({
            ...
            //显示字段数据
            columns:[
                {data : 'externalCode'}, {data : 'num'}, {data : 'projectName'},
                {data : 'parentBrandName'}, {data : 'originalAmount'}, {data : 'settlementRate'}, {data : 'rmbAmount'},{data : 'billTypeLabel'}
            ],
            //异步获取数据
            ajax:function(data, callback, settings){
    ...
    $("#audit-buttons").click(function(){
        ...
        var json = {"billId":id, "auditResult":auditResult,"auditRemark":auditRemark};
        var url = serverAddr + "/toCReceiveBill/auditItem.asyn";
        $custom.request.ajaxSync(url,json,function(result){
