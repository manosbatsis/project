...
<script type="text/javascript">
    $(function(){
        ...
        $("#file").change(function(){
            ...
            if(suffix=="xlsx" || suffix=="xls"){
                ...
                $custom.request.ajaxUpload(serverAddr+"/buMoveInventory/importBuMoveInventory.asyn", formData, function(result){
                    $(".popupbg").hide();
                    if(result.state == '200'){
    ...
    $("#downloadTemplate").click(function(){
        $downLoad.downLoadByUrl("/excelTemplate/download.asyn?ids=136");
    })
