...
$("#form-upload").on("change",'.file-import',function(){
	...
	if(suffix=="xlsx" || suffix=="xls"){
		...
		$custom.request.ajaxUpload(serverAddr+"/orderReturnIdepot/importOrder.asyn", formData, function(result){
			if(result.state == '200'){
	...
	$("#downloadTemplate").click(function(){
		$downLoad.downLoadByUrl("/excelTemplate/download.asyn?ids=126");
	})
