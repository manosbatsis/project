                        ...
                        <div class="modal-body">
                            <form id="popup-goods-form">
                                <div class="form-row mt10">
                                    ...
                                    <div class="col-2">
                                        <div class="row">
                                            <button type="button" class="btn btn-info waves-effect waves-light fr btn-sm" onclick='$m13012.show();'>查询</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
                            ...
                            <div class="form-row mt20">
                                <div class="form-inline m0auto">
                                    <div class=form-group>
                                        <button type="button" class="btn btn-info waves-effect waves-light fr" onclick='$m13012.save();'>确定</button>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<script type="text/javascript">
    var $m13012={
        init:function(obj){
            $m13012.params.thisObj = obj;
            $module.settlementConfig.getSettlementConfig.call($("select[name='projectId']")[0], '2', $m13012.params.customerId, "2", "2");
            $module.settlementConfig.getSettlementConfig.call($("select[name='parentId']")[0], '1', $m13012.params.customerId, "2", "2");
            this.show();
        },
        list:function(){
        ...
        show:function(){
            $($m13012.params.modalId).modal("show")
            this.list();
        },
        hide:function(){
            $($m13012.params.modalId).modal("hide");
        },
        save:function () {
            var count = 0;
            var projectId = null;
            ...
            $($m13012.params.thisObj).parent("td").find("input[name=projectId]").val(projectId);
            $($m13012.params.thisObj).val(projectName);
            $m13012.hide();
        },
        params:{
    ...
    function selectTable(obj, customerId){
        $m13012.params.customerId = customerId;
        var thead = '<tr>'
    ...
    function saleOrder(){
        ...
        var _table = $table.dataTable({
            ...
            ajax:function(data, callback, settings){
                ...
                $custom.request.ajax($m13012.params.projectUrl,getParams(data),
        ...
        function getParams(data){
            ...
            jsonData=$json.setJson(jsonData, "customerId", $m13012.params.customerId);
