            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                	...
                	<div class="form-row">
                          <div class="col-6">
                              <div class="row">
                                  <label  class="col-5 col-form-label " style="white-space:nowrap;"><div class="fr">商家名称<span>：</span></div></label>
        ...
        save:function(){
        	...
        	if(ids!=""){
	            ...
	            $.each(resultJson,function(index,event){
	            	tr+='<tr>' +
		   	         '<td class="tc nowrap"><i class="fi-plus" onclick="addtr();"></i>&nbsp;&nbsp;&nbsp;<i class="fi-minus" onclick="deltr(this);"></i><input type="hidden" name="goodsId" value='+(event.id==null?'':event.id)+'></td>' +
		   	         '<td><input type="hidden" name="goodsNo" value='+(event.goodsNo==null?'':event.goodsNo)+'>'+(event.goodsNo==null?'':event.goodsNo)+'<button type="button"class="btn btn-find waves-effect waves-light btn_default indepot_goods"onclick="initGoodsBefore(this);">选择商品</button></td>'+ 
		   	         '<td><input type="hidden" name="goodsName" value='+(event.name==null?'':event.name)+'>'+(event.name==null?'':event.name)+'</td>' +
		   	         ...
		   	         '<td><input type="text" class="form-control" value='+(event.filingPrice==null?'':event.filingPrice) + ' name="declarePrice" onkeyup="value=value.replace(/[^\\\\d^\.]/g,\'\')"  ></td>'+
		   	         '<td><input type="text" class="form-control" name="returnAmount" onkeyup="value=value.replace(/[^\\d^\.]/g,\'\')" ></td>' +
