            ...
            if(ids!=""){
                ...
                $.each(resultJson,function(index,event){
                    ...
                    $tr+="<tr>" +
                        ...
                        "<td><input type='text' name='goodsNo' style='border:none;' value='"+event.goodsNo+"' readonly></td>"+
                        "<td><input type='text' name='goodsName' style='border:none;' value='"+event.name+"' readonly></td>"+
                        "<td><input type='text' name='barcode' style='border:none;' value='"+event.barcode+"' readonly></td>"+
                        "<td><input type='text' name='brandName' style='border:none;' value='"+brandName+"' readonly></td>"+
                        "<td><input type='text' name='num' class='' value=''></td>"+
                        "<td><input type='text' name='price' class='goods-price'></td>"+
