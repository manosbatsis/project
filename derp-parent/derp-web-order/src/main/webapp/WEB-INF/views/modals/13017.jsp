                        ...
                        <div class="modal-body">
                            <form id="popup-goods-form">
                                <div class="form-row mt10">
                                    ...
                                    <div class="col-2">
                                        <div class="row">
                                            <button type="button" class="btn btn-info waves-effect waves-light fr btn-sm" onclick='$m13017.show();'>查询</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
                            ...
                            <div class="form-row mt20">
                                <div class="form-inline m0auto">
                                    <div class=form-group>
                                        <button type="button" class="btn btn-info waves-effect waves-light fr" onclick='$m13017.save();'>确定</button>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<script type="text/javascript">
    var $m13017={
        init:function(obj){
            $m13017.params.thisObj = obj;
            $module.settlementConfig.getSettlementConfig.call($("select[name='projectId']")[0], '2', $m13017.params.customerId, "1", "2");
            $module.settlementConfig.getSettlementConfig.call($("select[name='parentId']")[0], '1', $m13017.params.customerId, "1", "2");
            this.show();
        },
        list:function(){
        ...
        show:function(){
            $($m13017.params.modalId).modal("show")
            this.list();
        },
        hide:function(){
            $($m13017.params.modalId).modal("hide");
        },
        save:function () {
            var count = 0;
            var projectId = null;
            ...
            $($m13017.params.thisObj).parent("td").find("input[name=projectId]").val(projectId);
            $($m13017.params.thisObj).val(projectName);
            $m13017.hide();
        },
        params:{
    ...
    function selectTable(obj, customerId){
        $m13017.params.customerId = customerId;
        var thead = '<tr>'
    ...
    function saleOrder(){
        ...
        var _table = $table.dataTable({
            ...
            ajax:function(data, callback, settings){
                ...
                $custom.request.ajax($m13017.params.projectUrl,getParams(data),
        ...
        function getParams(data){
            ...
            jsonData=$json.setJson(jsonData, "customerId", $m13017.params.customerId);
