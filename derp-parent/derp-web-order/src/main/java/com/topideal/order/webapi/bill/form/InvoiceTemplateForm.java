...
import com.topideal.entity.dto.bill.InvoiceWeiPinTemplateItemDTO;
 ...
 **/
@ApiModel
public class InvoiceTemplateForm implements Serializable {
    ...
    private List<InvoiceTemplateItemForm> itemList;

    @ApiModelProperty("唯品发票明细")
    private List<InvoiceWeiPinTemplateItemForm> wpItemList;
    ...
    public List<InvoiceTemplateItemForm> getItemList() {
        return itemList;
    }

    public void setItemList(List<InvoiceTemplateItemForm> itemList) {
    ...
    public List<InvoiceWeiPinTemplateItemForm> getWpItemList() {
        return wpItemList;
    }

    public void setWpItemList(List<InvoiceWeiPinTemplateItemForm> wpItemList) {
