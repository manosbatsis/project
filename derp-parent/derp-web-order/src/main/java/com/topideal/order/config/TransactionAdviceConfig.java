package com.topideal.order.config;
...
public class TransactionAdviceConfig {
     ...
     * 定义切点路径
     */
    private static final String AOP_POINTCUT_EXPRESSION = "execution (* com.topideal.order.service..impl.*.*(..))";
    ...
    public TransactionInterceptor TxAdvice() {
        ...
        txMap.put("confirm*", txAttr_REQUIRED );
        txMap.put("audit*", txAttr_REQUIRED );
        txMap.put("examine*", txAttr_REQUIRED );
        txMap.put("submit*", txAttr_REQUIRED );
        txMap.put("syn*", txAttr_REQUIRED );
        txMap.put("get*", txAttr_REQUIRED_READONLY);
        txMap.put("find*", txAttr_REQUIRED_READONLY);
        txMap.put("list*", txAttr_REQUIRED_READONLY);
        txMap.put("refresh*", txAttr_REQUIRED_READONLY);
