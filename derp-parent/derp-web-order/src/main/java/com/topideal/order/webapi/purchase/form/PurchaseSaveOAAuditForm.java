 ...
 * @Description: 采购保存OA审核
 */
public class PurchaseSaveOAAuditForm implements Serializable {
    ...
    @ApiModelProperty(value = "数据ID,后续引用到PO执行合同的框架合同编号主键ID")
