 ...
 **/
@ApiModel
public class InvoiceTemplateYSForm implements Serializable {
    ...
    @ApiModelProperty("预收账单id，多个以逗号隔开")
    private String ids;
    /**
     * 备注
     */
    ...
    private List<InvoiceTemplateItemYSForm> itemList;

    @ApiModelProperty("发票详情明细")
    private List<InvoiceTemplateItemDetailsYSForm>detailsItemList;
    /**
     * 发票总金额
     */
    ...
    @ApiModelProperty("详情总金额")
    private String detailsTotalAmount;

    @ApiModelProperty("详情总数量")
    private String detailsTotalNum;
	...
	public List<InvoiceTemplateItemYSForm> getItemList() {
		return itemList;
	}

	public void setItemList(List<InvoiceTemplateItemYSForm> itemList) {
		this.itemList = itemList;
	}

	public List<InvoiceTemplateItemDetailsYSForm> getDetailsItemList() {
		return detailsItemList;
	}

	public void setDetailsItemList(List<InvoiceTemplateItemDetailsYSForm> detailsItemList) {
	...
	public String getDetailsTotalNum() {
		return detailsTotalNum;
	}

	public void setDetailsTotalNum(String detailsTotalNum) {
		this.detailsTotalNum = detailsTotalNum;
	}
