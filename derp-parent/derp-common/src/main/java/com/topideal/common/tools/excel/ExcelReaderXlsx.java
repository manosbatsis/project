 ...
 *
 */
public class ExcelReaderXlsx extends DefaultHandler implements HSSFListener {
...
//    private int totalRows=0;
    ...
    public List<Map<String, String>> processSingleSheet(String filename) throws Exception {
    	...
    	List<List<Map<String, String>>> sheetList = processMultiSheet(filename, null, 1, null);
    ...
    public List<Map<String, String>> processSingleSheet(InputStream is) throws Exception {
    	...
    	List<List<Map<String, String>>> sheetList = processMultiSheet(null, is, 1, null) ;
    ...
    public List<List<Map<String, String>>> processMultiSheet(String filename) throws Exception {
    	...
    	List<List<Map<String, String>>> sheetList = processMultiSheet(filename, null, null, null);
    ...
    public List<List<Map<String, String>>> processMultiSheet(InputStream is) throws Exception {
    	...
    	List<List<Map<String, String>>> sheetList = processMultiSheet(null, is, null, null) ;
    ...
    public List<Map<String, String>> processAppointSheet(String filename, Integer appointSheetIndex) throws Exception {
    	...
    	List<List<Map<String, String>>> sheetList = processMultiSheet(filename, null, appointSheetIndex, null);
    ...
    public List<Map<String, String>> processAppointSheet(InputStream is, Integer appointSheetIndex) throws Exception {
    	...
    	List<List<Map<String, String>>> sheetList = processMultiSheet(null, is, appointSheetIndex, null) ;
    ...
    public List<Map<String, String>> processAppointSheet(String filename, String appointSheetName) throws Exception {
    	...
    	List<List<Map<String, String>>> sheetList = processMultiSheet(filename, null, null, appointSheetName);
    ...
    public List<Map<String, String>> processAppointSheet(InputStream is, String appointSheetName) throws Exception {
    	...
    	List<List<Map<String, String>>> sheetList = processMultiSheet(null, is, null, appointSheetName) ;
     ...
     * @throws Exception
     */
    private List<List<Map<String, String>>> processMultiSheet(String filename, InputStream is, Integer appointSheetIndex, String appointSheetName) throws Exception {
        OPCPackage pkg = null ;
        ...
        while (sheets.hasNext()) { //遍历sheet
            ...
            if(StringUtils.isNotBlank(appointSheetName) && !sheetName.equals(appointSheetName)) {
            	continue ;
            }
    ...
    public void setNextDataType(Attributes attributes) {
        ...
        if (cellStyleStr != null) { //处理日期
            ...
            if (formatString.contains("m/d/yyyy") 
        ...
        switch (nextDataType) {
            ...
            case SSTINDEX: //字符串
                ...
                try {
                    ...
                    //有些字符串是文本格式的，但内容却是日期
                    //判断是否日期格式支持(yyyy-MM-dd 和 yyyy/MM/dd)
                    ...
                    if(pattern.matcher(thisStr).matches()) {
                    	...
                    	if(thisStr.indexOf("/") > -1
                    		...
                    		Timestamp times = TimeUtils.parse(thisStr, "yyyy/MM/dd HH:mm:ss");
                    		thisStr = TimeUtils.format(times, "yyyy-MM-dd HH:mm:ss") ;
                    		
                    	}else if(thisStr.indexOf("/") > -1) {
                    		
                    		Timestamp times = TimeUtils.parse(thisStr, "yyyy/MM/dd");
                    		thisStr = TimeUtils.format(times, "yyyy-MM-dd") ;
