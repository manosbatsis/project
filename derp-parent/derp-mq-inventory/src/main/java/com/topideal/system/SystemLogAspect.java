...
public  class SystemLogAspect {
    ...
    public  void doAfterReturning(JoinPoint joinPoint,Object rvt) {
        ...
        try {
            ...
            //推送到日志MQ平台
            jsonObject.put("moduleCode", LogModuleType.MODULE_INVENTORY.getType());
            SendResult sendResult = rocketMQProducer.send(jsonObject.toString(), MQLogEnum.LOG_CONSUME_INVENTORY.getTopic(),MQLogEnum.LOG_CONSUME_INVENTORY.getTags());
            jsonObject.put("modulCode", "1004");
