...
public class WorkflowRequestTableField  implements java.io.Serializable {
        ...
        _equals = true && 
            ...
            ((this.selectnames==null && other.getSelectnames()==null) || 
             (this.selectnames!=null &&
              java.util.Arrays.equals(this.selectnames, other.getSelectnames()))) &&
            ((this.selectvalues==null && other.getSelectvalues()==null) || 
             (this.selectvalues!=null &&
              java.util.Arrays.equals(this.selectvalues, other.getSelectvalues()))) &&
    ...
    public synchronized int hashCode() {
        ...
        if (getSelectnames() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getSelectnames());
                 i++) {
                Object obj = java.lang.reflect.Array.get(getSelectnames(), i);
                if (obj != null &&
        ...
        if (getSelectvalues() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getSelectvalues());
                 i++) {
                Object obj = java.lang.reflect.Array.get(getSelectvalues(), i);
                if (obj != null &&
                    !obj.getClass().isArray()) {
                    _hashCode += obj.hashCode();
                }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://webservices.workflow.weaver", "WorkflowRequestTableField"));
