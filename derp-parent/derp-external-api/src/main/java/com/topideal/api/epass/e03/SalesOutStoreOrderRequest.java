package com.topideal.api.epass.e03;
 ...
 *2018/5/30
 */
public class SalesOutStoreOrderRequest {
	...
	private String total_num;//件数合计数量
	private String panel_wallTotalNum;//托板合计数量
	private Double volume_totalnum;//体积合计 2位小数
	private List<SalesOutStoreOrderItemRequest> goods_list;//商品信息标签
	...
	public String getPanel_wallTotalNum() {
		return panel_wallTotalNum;
	}
	public void setPanel_wallTotalNum(String panel_wallTotalNum) {
	...
	public List<SalesOutStoreOrderItemRequest> getGoods_list() {
		return goods_list;
	}
	public void setGoods_list(List<SalesOutStoreOrderItemRequest> goods_list) {
