...
public class InventoryLocationMappingDTO extends PageModel implements Serializable{
    ...
    */
	...
	@ApiModelProperty(value = "isorRappointLabel")
    private String isorRappointLabel;

    public String getIsorRappointLabel() {
		return isorRappointLabel;
	}
	public void setIsorRappointLabel(String isorRappointLabel) {
		this.isorRappointLabel = isorRappointLabel;
	}
	/*id get 方法 */
    public Long getId(){
    return id;
    ...
    this.type=type;
    this.typeLabel = DERP_SYS.getLabelByKey(DERP_SYS.invenlocaitonMapping_TypeList, type) ;
    }
    /*creator get 方法 */
    ...
    public void setIsorRappoint(String isorRappoint) {
    	this.isorRappointLabel = DERP_SYS.getLabelByKey(DERP_SYS.invenlocaitonMapping_isorRappoint, isorRappoint) ;
