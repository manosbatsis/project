 ...
 *
 */
public class MerchantShopRelDTO extends PageModel implements Serializable{
    ...
    private String isSycnMerchandiseLabel;

    //货主公司
    private List<Map<String, String>> shipperList;
    ...
    private String storeTypeCodeLabel;
    ...
    public void setStatus(String  status){
        this.status=status;
        if(status != null) {
            this.statusLabel = DERP_SYS.getLabelByKey(DERP_SYS.merchantShopRel_statusList, status);
        }
    }
    /*createDate get 方法 */
    ...
    public List<Map<String, String>> getShipperList() {
        return shipperList;
    }
    public void setShipperList(List<Map<String, String>> shipperList) {
    ...
    public void setIsSycnMerchandise(String isSycnMerchandise) {
        ...
        this.isSycnMerchandiseLabel = DERP_SYS.getLabelByKey(DERP_SYS.merchantShopRel_isSycnMerchandiseList, isSycnMerchandise);
    }
    public String getIsSycnMerchandiseLabel() {
        return isSycnMerchandiseLabel;
    }
    public void setIsSycnMerchandiseLabel(String isSycnMerchandiseLabel) {
        this.isSycnMerchandiseLabel = isSycnMerchandiseLabel;
    }
    ...
    public void setStoreTypeCode(String storeTypeCode) {
        ...
        if(storeTypeCode != null) {
            this.storeTypeCodeLabel = DERP_SYS.getLabelByKey(DERP_SYS.merchantShopRel_storeTypeList, storeTypeCode);
        }
    }

    public String getStoreTypeCodeLabel() {
        return storeTypeCodeLabel;
    }

    public void setStoreTypeCodeLabel(String storeTypeCodeLabel) {
        this.storeTypeCodeLabel = storeTypeCodeLabel;
    }
