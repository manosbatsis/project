 ...
 * 权限信息表
 */
public class PermissionInfoDTO extends PageModel implements Serializable{
    ...
    //id
	 ...
	 @ApiModelProperty(value = "模块 1-主服务-main 2-业务-order 3-仓储-storage 4-库存-inventory 5-报表-report")
