...
public class BrandParentDTO extends PageModel implements Serializable{
    ...
    * 上级母品牌编码
    */
	@ApiModelProperty(value = "上级母品牌编码")
    ...
    */
	...
	public void setAuthorizer(String authorizer) {
		...
		this.authorizerLabel = DERP_SYS.getLabelByKey(DERP_SYS.brandParent_authorizerList, authorizer);
	}
	public String getAuthorizerLabel() {
		return authorizerLabel;
	}
	public void setAuthorizerLabel(String authorizerLabel) {
		this.authorizerLabel = authorizerLabel;
	}
	...
	public void setType(String type) {
		this.type = type;
		this.typeLabel = DERP_SYS.getLabelByKey(DERP_SYS.brandParent_typeList, type);
	}
