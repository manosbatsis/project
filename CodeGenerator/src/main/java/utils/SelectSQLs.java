...
public interface SelectSQLs {
	...
	public static final String MYSQL_QUERY_COLUMNS = "select lower(c.COLUMN_NAME) column_name,c.DATA_TYPE,c.COLUMN_COMMENT comments,replace(c.COLUMN_KEY,'PRI','1') is_primary from information_schema.COLUMNS c where c.TABLE_NAME =? and c.TABLE_SCHEMA =? order by c.ORDINAL_POSITION";
