...
public class StringUtill {
	...
	/**
	 * 修改表名称为驼峰式，表名称将XXXX_XXXXX转化为形式为XxxXxxxx
	 * 
	 * @param oldName
	 * @return String
	 */
	public static final String camelTableName(String oldName) {
		if (oldName == null)
			return "";
	...
	/**
	 * 修改列名称为驼峰式，将XXXX_XXXXX转化为形式为xxxXxxxx
	 * 
	 * @param oldName
	 * @return String
	 */
	public static final String camelColumnName(String oldName) {
		if (oldName == null)
			return "";
		String[] name = oldName.toLowerCase().split("_");
		String newName = "";
	...
	public static void main(String[] args) {
		...
		System.out.println(camelColumnName(s));
		System.out.println(camelTableName(s));
	}
}
