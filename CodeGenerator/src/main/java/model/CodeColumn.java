...
public class CodeColumn {
	...
	private String columnNameKeep;// 转化成java对应的列名 关键字的时候
	...
	public String getColumnNameKeep() {
		return columnNameKeep;
	}

	public void setColumnNameKeep(String columnNameKeep) {
		this.columnNameKeep = columnNameKeep;
	}

	@Override
	public String toString() {
		return "CodeColumn [columnName=" + columnName + ", columnType=" + columnType + ", columnComments="
				+ columnComments + ", isPrimary=" + isPrimary + ", dataName=" + dataName + ", dataType=" + dataType
				+ ", columnNameKeep=" + columnNameKeep + "]";
	}
